...
(function (bc19) {
    var Castle = (function (_super) {
        ...
        /*private*/ Castle.goForDef = function () {
            bc19.Util.mr.log("ST: " + bc19.Util.seenIPreNear + " - " + bc19.Util.seenIProNear);
        ...
        /*private*/ Castle.goodTimeForRush = function () {
            {
                if (bc19.Communication.smessage % 16 !== 10 && bc19.Communication.smessage % 16 !== 12)
                    Castle.wave = 0;
    ...
    var Nav = (function (_super) {
        ...
        Nav.destSetPilgrimToResource = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                ...
                {
                    var array204 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index203 = 0; index203 < array204.length; index203++) {
                        var dir = array204[index203];
                        {
                            pi = po.dir4To(dir);
        ...
        /*private*/ Nav.calcEnemyCastle = function () {
            for (var index207 = 0; index207 < bc19.Util.castlei_$LI$().length; index207++) {
                var po = bc19.Util.castlei_$LI$()[index207];
                {
            ...
            if (bc19.Util.revPoint(bc19.Util.myCC).ocastle)
        ...
        /*private*/ Nav.sadbfs = function (goal) {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array209 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index208 = 0; index208 < array209.length; index208++) {
                        var dir = array209[index208];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
        ...
        Nav.goForExpand1 = function () {
            ...
            var mnn = 1000000;
            var gg = null;
            for (var index218 = 0; index218 < bc19.Util.karbonP_$LI$().length; index218++) {
                var kp = bc19.Util.karbonP_$LI$()[index218];
                {
                    mn = 1000000;
                    for (var index219 = 0; index219 < bc19.Util.castlei_$LI$().length; index219++) {
                        var po = bc19.Util.castlei_$LI$()[index219];
                        {
                            if (kp.distxy$bc19_Point(po) < mn)
                                mn = kp.distxy$bc19_Point(po);
                        }
                    }
                    for (var index220 = 0; index220 < bc19.Util.castleo_$LI$().length; index220++) {
                        var po = bc19.Util.castleo_$LI$()[index220];
                        {
                            if (kp.distxy$bc19_Point(po) < mn)
                                mn = kp.distxy$bc19_Point(po);
                        }
        ...
        Nav.expandTargeti = function () {
            ...
            var value;
            var gg = null;
            for (var index221 = 0; index221 < bc19.Util.resToDep_$LI$().length; index221++) {
                var po = bc19.Util.resToDep_$LI$()[index221];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index222 = 0; index222 < bc19.Util.castlei_$LI$().length; index222++) {
                        var poo = bc19.Util.castlei_$LI$()[index222];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    }
                    for (var index223 = 0; index223 < bc19.Util.castleo_$LI$().length; index223++) {
                        var poo = bc19.Util.castleo_$LI$()[index223];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    ...
                    if (po.distxy$bc19_Point(bc19.Util.myp) <= mn) {
                        var valid = true;
                        for (var index224 = 0; index224 < bc19.Castle.doneDep_$LI$().length; index224++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index224];
                            {
                        ...
                        for (var index225 = 0; index225 < bc19.Castle.lookInProg_$LI$().length; index225++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index225];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index226 = 0; index226 < bc19.Util.castlei_$LI$().length; index226++) {
                            var pp = bc19.Util.castlei_$LI$()[index226];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.expandTargetXXX = function () {
            ...
            var value;
            var gg = null;
            for (var index227 = 0; index227 < bc19.Util.resToDep_$LI$().length; index227++) {
                var po = bc19.Util.resToDep_$LI$()[index227];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index228 = 0; index228 < bc19.Util.castlei_$LI$().length; index228++) {
                        var poo = bc19.Util.castlei_$LI$()[index228];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    }
                    for (var index229 = 0; index229 < bc19.Util.castleo_$LI$().length; index229++) {
                        var poo = bc19.Util.castleo_$LI$()[index229];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    ...
                    if (po.distxy$bc19_Point(bc19.Util.myp) <= mn) {
                        var valid = true;
                        for (var index230 = 0; index230 < bc19.Castle.doneDep_$LI$().length; index230++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index230];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index231 = 0; index231 < bc19.Castle.lookInProg_$LI$().length; index231++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index231];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index232 = 0; index232 < bc19.Util.castlei_$LI$().length; index232++) {
                            var pp = bc19.Util.castlei_$LI$()[index232];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.nextAssignDefPre = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array234 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index233 = 0; index233 < array234.length; index233++) {
                        var dir = array234[index233];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
        ...
        /*private*/ Nav.AStarIsBack9h = function (goal) {
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array248 = function () { var result = []; for (var val in bc19.Direction9) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
        ...
        Nav.expandTargetCCC = function () {
            ...
            for (var index249 = 0; index249 < bc19.Util.resToDep_$LI$().length; index249++) {
                var po = bc19.Util.resToDep_$LI$()[index249];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index250 = 0; index250 < bc19.Util.castlei_$LI$().length; index250++) {
                        var poo = bc19.Util.castlei_$LI$()[index250];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    }
                    for (var index251 = 0; index251 < bc19.Util.castleo_$LI$().length; index251++) {
                        var poo = bc19.Util.castleo_$LI$()[index251];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    ...
                    if (po.distxy$bc19_Point(bc19.Util.myCC) <= mn) {
                        var valid = true;
                        for (var index252 = 0; index252 < bc19.Castle.doneDep_$LI$().length; index252++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index252];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index253 = 0; index253 < bc19.Castle.lookInProg_$LI$().length; index253++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index253];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index254 = 0; index254 < bc19.Util.castlei_$LI$().length; index254++) {
                            var pp = bc19.Util.castlei_$LI$()[index254];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
...
(function (bc19) {
    var Preacher = (function (_super) {
        ...
        Preacher.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array256 = bc19.Util.mr.getVisibleRobots();
                    for (var index255 = 0; index255 < array256.length; index255++) {
                        var r = array256[index255];
                        {
                            if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                                /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                                    s.push(e);
        ...
        /*private*/ Preacher.setAttackLand = function () {
            ...
            var poo = null;
            {
                var array258 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index257 = 0; index257 < array258.length; index257++) {
                    var dir = array258[index257];
                    {
        ...
        /*private*/ Preacher.checkFight = function () {
            ...
            var poo = null;
            {
                var array262 = bc19.Util.mr.getVisibleRobots();
                for (var index261 = 0; index261 < array262.length; index261++) {
                    var r = array262[index261];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 16) {
...
(function (bc19) {
    var Church = (function (_super) {
        ...
        Church.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                bc19.Util.myCC = bc19.Util.myp;
                for (var index265 = 0; index265 < bc19.Util.resP_$LI$().length; index265++) {
                    var po = bc19.Util.resP_$LI$()[index265];
                    {
                        if (bc19.Util.myp.distxy$bc19_Point(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
        ...
        /*private*/ Church.checkFight = function () {
            ...
            var poo = null;
            {
                var array267 = bc19.Util.mr.getVisibleRobots();
                for (var index266 = 0; index266 < array267.length; index266++) {
                    var r = array267[index266];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
        ...
        /*private*/ Church.canProduceUnit = function () {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array269 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index268 = 0; index268 < array269.length; index268++) {
                    var dir = array269[index268];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                            return dir;
...
(function (bc19) {
    var Prophet = (function (_super) {
        ...
        Prophet.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array273 = bc19.Util.mr.getVisibleRobots();
                    for (var index272 = 0; index272 < array273.length; index272++) {
                        var r = array273[index272];
                        if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() || r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) {
                            if (bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 2) {
                                bc19.Util.myCC = bc19.Util.p[r.x][r.y];
                                if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
        ...
        /*private*/ Prophet.tryToGoToSafe = function () {
            ...
            {
                var array275 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index274 = 0; index274 < array275.length; index274++) {
                    var dir = array275[index274];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
        ...
        Prophet.isItSafe = function (po) {
            for (var index278 = 0; index278 < bc19.Util.seenO.length; index278++) {
                var ppo = bc19.Util.seenO[index278];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 26)
        ...
        Prophet.isItSafeX = function (po) {
            for (var index279 = 0; index279 < bc19.Util.seenO.length; index279++) {
                var ppo = bc19.Util.seenO[index279];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 26)
        ...
        /*private*/ Prophet.justRunAway = function () {
            Prophet.runAway = null;
            {
                var array282 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index281 = 0; index281 < array282.length; index281++) {
                    var dir = array282[index281];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
        ...
        /*private*/ Prophet.checkFight = function () {
            ...
            var poo = null;
            {
                var array284 = bc19.Util.mr.getVisibleRobots();
                for (var index283 = 0; index283 < array284.length; index283++) {
                    var r = array284[index283];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
