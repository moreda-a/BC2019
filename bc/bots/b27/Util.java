...
public class Util {
	...
	public static int seenICas = 0;
	public static int seenICasNear = 0;
	public static int seenIChu = 0;
	public static int seenIChuNear = 0;
	public static int seenICru = 0;
	public static int seenICruNear = 0;
