...
//			}
			...
			// if (me.turn >= 50)
			{
				if (seenIPilNear >= resGoalP.size() && pili < 3
				...
				// seenIPil
				{
					if (Nav.expandTarget() != null && (pre >= 1 || mr.karbonite >= 10 && mr.fuel >= 50)
							&& seenO.size() == 0) {// why ?
						lastPili = me.turn;
						pili++;
						return UnitType.Pilgrim;
...
//		}
		...
		// if (me.turn >= 50)
		{
			...
			// * xid.size() + 2))
			{
				if (Nav.expandTarget() != null && (pre >= 1 || mr.karbonite >= 40 && mr.fuel >= 100)
						&& seenO.size() == 0) {// why ?
					lastPili = me.turn;
					pili++;
					return UnitType.Pilgrim;
