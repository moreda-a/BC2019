...
public class Util {
	...
	public static HashSet<Point> karbonP = new HashSet<Point>();
	public static HashSet<Point> fuelP = new HashSet<Point>();
	public static HashSet<Point> resGoalP = new HashSet<Point>();
