...
(function (bc19) {
    var Util = (function () {
        ...
        ;
        Util.resP_$LI$ = function () { if (Util.resP == null)
            Util.resP = ([]); return Util.resP; };
        ;
        Util.resGoalP_$LI$ = function () { if (Util.resGoalP == null)
            Util.resGoalP = ([]); return Util.resGoalP; };
        ;
        Util.resToDep_$LI$ = function () { if (Util.resToDep == null)
            Util.resToDep = ([]); return Util.resToDep; };
        ;
        Util.potDep_$LI$ = function () { if (Util.potDep == null)
            Util.potDep = ([]); return Util.potDep; };
        ;
        Util.allKnownR_$LI$ = function () { if (Util.allKnownR == null)
            Util.allKnownR = new Array(4096); return Util.allKnownR; };
        ;
        Util.typeKnownR_$LI$ = function () { if (Util.typeKnownR == null)
            Util.typeKnownR = (function (s) { var a = []; while (s-- > 0)
                a.push(0); return a; })(4096); return Util.typeKnownR; };
        ;
        Util.xr_$LI$ = function () { if (Util.xr == null)
            Util.xr = (function (s) { var a = []; while (s-- > 0)
                a.push(0); return a; })(4096); return Util.xr; };
        ;
        Util.yr_$LI$ = function () { if (Util.yr == null)
            Util.yr = (function (s) { var a = []; while (s-- > 0)
                a.push(0); return a; })(4096); return Util.yr; };
        ;
        Util.lastKnownR_$LI$ = function () { if (Util.lastKnownR == null)
            Util.lastKnownR = (function (s) { var a = []; while (s-- > 0)
                a.push(0); return a; })(4096); return Util.lastKnownR; };
        ;
        Util.knownRList_$LI$ = function () { if (Util.knownRList == null)
            Util.knownRList = ([]); return Util.knownRList; };
        ;
        Util.knownRListChu_$LI$ = function () { if (Util.knownRListChu == null)
            Util.knownRListChu = ([]); return Util.knownRListChu; };
        ;
        Util.init = function (myRobot) {
            ...
            for (var i = 0; i < Util.size; ++i) {
                for (var j = 0; j < Util.size; ++j) {
                    ...
                    if (Util.mr.karboniteMap[j][i]) {
                        /* add */ (Util.karbonP_$LI$().push(Util.p[i][j]) > 0);
                        /* add */ (Util.resP_$LI$().push(Util.p[i][j]) > 0);
                    }
                    if (Util.mr.fuelMap[j][i]) {
                        /* add */ (Util.fuelP_$LI$().push(Util.p[i][j]) > 0);
                        /* add */ (Util.resP_$LI$().push(Util.p[i][j]) > 0);
                    }
                    if (Util.horizontal && Util.vertical && Util.mr.map[j][i] !== Util.mr.map[Util.size - j - 1][i]) {
                        Util.vertical = false;
                    }
                    if (Util.horizontal && Util.vertical && Util.mr.map[j][i] !== Util.mr.map[j][Util.size - i - 1]) {
                        Util.horizontal = false;
                    }
                }
                ;
            }
            ...
            Util.initDone = true;
            Util.mr.log("init Passed :D : " + Util.style);
        };
        ...
        /*private*/ Util.radioHandle = function () {
            {
                var array122 = Util.mr.getVisibleRobots();
        ...
        /*private*/ Util.visibileHandle = function () {
            Util.seenI = ([]);
            Util.seenO = ([]);
            Util.seenIR = ([]);
            Util.seenOR = ([]);
            ...
            var pp;
            {
                var array124 = Util.mr.getVisibleRobots();
                for (var index123 = 0; index123 < array124.length; index123++) {
                    var r = array124[index123];
                    {
                        if (!Util.mr.isVisible(r))
                            continue;
                        pp = Util.p[r.x][r.y];
                        if (r.team === bc19.Team["_$wrappers"][Util.teami].number() && pp !== Util.myp) {
                            /* add */ (Util.seenI.push(pp) > 0);
                            /* add */ (Util.seenIR.push(r) > 0);
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                                ...
                                if (Util.myp.distxy$bc19_Point(pp) <= 6)
                                    Util.seenICasNear++;
                                Util.seenICas++;
                            }
                            ...
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                                if (Util.myp.distxy$bc19_Point(pp) <= 6) {
                                    Util.seenIPreNear++;
                                    /* add */ (Util.seenIPreP.push(pp) > 0);
                                }
                                Util.seenIPre++;
                            }
                        }
                        if (r.team === bc19.Team["_$wrappers"][Util.teamo].number()) {
                            /* add */ (Util.seenO.push(pp) > 0);
                            /* add */ (Util.seenOR.push(r) > 0);
                            pp.id = r.id;
                            pp.unit = r.unit;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
            ...
            Util.mr.log("seen: " + Util.seenI.length + " - " + Util.seenO.length);
        };
        Util.calcDep = function () {
            var mx = -100;
            var pi = null;
            var ppo = null;
            var first = ([]);
            for (var index125 = 0; index125 < Util.resP_$LI$().length; index125++) {
                var po = Util.resP_$LI$()[index125];
                {
                    {
                        var array127 = function () { var result = []; for (var val in bc19.Direction) {
                            if (!isNaN(val)) {
                                result.push(parseInt(val, 10));
                            }
                        } return result; }();
            ...
            for (var index128 = 0; index128 < Util.resP_$LI$().length; index128++) {
                var po = Util.resP_$LI$()[index128];
                {
                    mx = -1;
                    ppo = null;
                    {
                        var array130 = function () { var result = []; for (var val in bc19.Direction9) {
                            if (!isNaN(val)) {
                                result.push(parseInt(val, 10));
                            }
                        } return result; }();
                        for (var index129 = 0; index129 < array130.length; index129++) {
                            var dir = array130[index129];
                            {
                                pi = po.dir9To(dir);
        ...
        Util.revPoint = function (po) {
            if (po == null) {
                Util.mr.log("ERROR: rev Point of null");
                return null;
            }
            if (Util.vertical)
                return Util.p[po.x][Util.size - po.y - 1];
            if (Util.horizontal)
                return Util.p[Util.size - po.x - 1][po.y];
            Util.mr.log("Fuck no VH");
            return null;
        };
        return Util;
    }());
    ...
    Util.seenOCru = 0;
    Util.seenOCruNear = 0;
    Util.attackTarget = null;
    Util.attackTargetR = null;
    Util.dangerEnemy = null;
    Util.dangerEnemyId = -1;
    Util.pil = 0;
    Util.pre = 0;
    Util.pro = 0;
    Util.cru = 0;
...
(function (bc19) {
    var Point = (function () {
        function Point(x, y, passable, karbonite, fuel) {
            this.icastle = false;
            this.ocastle = false;
            this.ocastleNotDes = true;
            this.icastleNotDes = true;
            this.nearValue = 0;
            this.update = -1;
            this.id = -1;
            this.unit = -1;
        ...
        Point.prototype.dist2$bc19_Point = function (po) {
            return (this.x - po.x) * (this.x - po.x) + (this.y - po.y) * (this.y - po.y);
        };
        Point.prototype.distxy$bc19_Point = function (po) {
        ...
        Point.prototype.distxy$int$int = function (ix, iy) {
            return Math.abs(this.x - ix) + Math.abs(this.y - iy);
        };
        Point.prototype.distxy = function (ix, iy) {
            if (((typeof ix === 'number') || ix === null) && ((typeof iy === 'number') || iy === null)) {
                return this.distxy$int$int(ix, iy);
            }
            else if (((ix != null && ix instanceof bc19.Point) || ix === null) && iy === undefined) {
                return this.distxy$bc19_Point(ix);
            }
            else
                throw new Error('invalid overload');
        };
        Point.prototype.dist2$int$int = function (ix, iy) {
            return (this.x - ix) * (this.x - ix) + (this.y - iy) * (this.y - iy);
        };
        Point.prototype.dist2 = function (ix, iy) {
            if (((typeof ix === 'number') || ix === null) && ((typeof iy === 'number') || iy === null)) {
                return this.dist2$int$int(ix, iy);
            }
            else if (((ix != null && ix instanceof bc19.Point) || ix === null) && iy === undefined) {
                return this.dist2$bc19_Point(ix);
            }
            else
                throw new Error('invalid overload');
        };
...
(function (bc19) {
     ...
     *
     */
    pointStack.__bc19_pointStack_serialVersionUID = -1635457372663188125;
    bc19.pointStack = pointStack;
    pointStack["__class"] = "bc19.pointStack";
    pointStack["__interfaces"] = ["java.util.RandomAccess", "java.util.List", "java.lang.Cloneable", "java.util.Collection", "java.lang.Iterable", "java.io.Serializable"];
})(bc19 || (bc19 = {}));
(function (bc19) {
    /**
...
(function (bc19) {
    var Crusader = (function (_super) {
        ...
        Crusader.lastmyp_$LI$ = function () { if (Crusader.lastmyp == null)
            Crusader.lastmyp = ([]); return Crusader.lastmyp; };
        ;
        Crusader.turn = function (myRobot) {
            bc19.Util.setupt(myRobot);
            /* add */ (Crusader.lastmyp_$LI$().push(bc19.Util.myp) > 0);
            if (bc19.Util.me.turn === 1) {
                Crusader.madeByCastle = false;
                {
                    var array132 = bc19.Util.mr.getVisibleRobots();
                    for (var index131 = 0; index131 < array132.length; index131++) {
                        var r = array132[index131];
                        if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() || r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) {
                            if (bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 2) {
                                bc19.Util.myCC = bc19.Util.p[r.x][r.y];
                                if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                                    Crusader.madeByCastle = true;
                                }
                                else
                                    Crusader.madeByCastle = false;
                            }
                ...
                if (bc19.Util.mr.karbonite === 85 && bc19.Util.mr.fuel === 475)
                    Crusader.firstIdiot = true;
            }
            Crusader.checkFight();
            if (bc19.Util.dangerEnemy == null && bc19.Util.attackTarget != null) {
                bc19.Util.mr.log("attack by a crusader. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
                return bc19.Util.mr.attack(bc19.Util.myp.dxTo(bc19.Util.attackTarget), bc19.Util.myp.dyTo(bc19.Util.attackTarget));
            }
            else if (bc19.Util.attackTarget == null) {
                if (!bc19.Util.mr.lastActionDone) {
                    /* push */ (bc19.Util.mainPath.push(Crusader.savePo) > 0);
                }
                if (Crusader.followTarget != null) {
                    var fc = bc19.Nav.followCru(Crusader.followTarget);
                    if (fc != null && Crusader.canReach(fc)) {
                        bc19.Util.mr.log("cru go to follow x: " + fc.x + " y: " + fc.y);
                        return bc19.Util.mr.move(bc19.Util.myp.dxTo(fc), bc19.Util.myp.dyTo(fc));
                    }
                }
                if (bc19.Util.dest === bc19.Util.myp) {
                    if (Crusader.mode === 0) {
                        bc19.Util.mr.log("stoping here");
                        if (Crusader.firstDest === bc19.Util.dest && Crusader.firstIdiot)
                            Crusader.mode = 5;
                        bc19.Util.dest = null;
                        return null;
                    }
                    bc19.Util.dest.ocastle = false;
                    bc19.Util.dest.ocastleNotDes = false;
                    bc19.Util.dest = null;
                }
                if ((bc19.Util.dest == null && Crusader.lastTry + 5 <= bc19.Util.me.turn) || (bc19.Util.me.turn > 6 && Crusader.lastmyp_$LI$()[bc19.Util.me.turn - 5].x === bc19.Util.myp.x && Crusader.lastmyp_$LI$()[bc19.Util.me.turn - 5].y === bc19.Util.myp.y && Crusader.lastTry + 5 <= bc19.Util.me.turn)) {
                    if (Crusader.mode === 0) {
                        if (Crusader.firstIdiot) {
                            bc19.Util.mainPath = bc19.Nav.harasCru();
                            if (Crusader.firstDest == null && bc19.Util.dest != null)
                                Crusader.firstDest = bc19.Util.dest;
                        }
                        else
                            bc19.Util.mainPath = bc19.Nav.defWithCru();
                    }
                    if (Crusader.mode !== 0) {
                        bc19.Util.mainPath = bc19.Nav.slowAttEnemeyCastle();
                    }
                ...
                if (bc19.Util.dest != null && bc19.Util.dest !== bc19.Util.myp) {
                    ...
                    if (Crusader.mode === 5 && bc19.Util.myp.dist2$bc19_Point(po) === 4) {
                        bc19.Util.mr.log("ss3");
                        var xx = bc19.Util.myp.x + (bc19.Util.myp.dxTo(po) / 2 | 0);
                        var yy = bc19.Util.myp.y + (bc19.Util.myp.dyTo(po) / 2 | 0);
                        if (Crusader.canReach(bc19.Util.p[xx][yy])) {
                            bc19.Util.mr.log("move slowRush a cru. x: " + bc19.Util.p[xx][yy].x + " y: " + bc19.Util.p[xx][yy].y);
                            return bc19.Util.mr.move(bc19.Util.myp.dxTo(bc19.Util.p[xx][yy]), bc19.Util.myp.dyTo(bc19.Util.p[xx][yy]));
                        }
                    }
                    if (Crusader.canReach(po)) {
                        /* pop */ bc19.Util.mainPath.pop();
                        Crusader.savePo = po;
                        bc19.Util.mr.log("move(1) a cru. x: " + po.x + " y: " + po.y);
                        ...
                        if (bc19.Util.mainPath.length === 1) {
                            ...
                            var yy = bc19.Util.myp.y + (bc19.Util.myp.dyTo(po) / 2 | 0);
                            if (Crusader.canReach(bc19.Util.p[xx][yy])) {
                                bc19.Util.mr.log("move(2) a cru. x: " + bc19.Util.p[xx][yy].x + " y: " + bc19.Util.p[xx][yy].y);
                                return bc19.Util.mr.move(bc19.Util.myp.dxTo(bc19.Util.p[xx][yy]), bc19.Util.myp.dyTo(bc19.Util.p[xx][yy]));
                            }
                        }
                        else {
                            ...
                            if (Crusader.canReach(bc19.Util.p[xx][yy])) {
                                bc19.Util.mr.log("move(3) a cru. x: " + bc19.Util.p[xx][yy].x + " y: " + bc19.Util.p[xx][yy].y);
                                return bc19.Util.mr.move(bc19.Util.myp.dxTo(bc19.Util.p[xx][yy]), bc19.Util.myp.dyTo(bc19.Util.p[xx][yy]));
                            }
                            else {
                                ...
                                if (Crusader.canReach(bc19.Util.p[xx][yy])) {
                                    bc19.Util.mr.log("move(4) a cru. x: " + bc19.Util.p[xx][yy].x + " y: " + bc19.Util.p[xx][yy].y);
                                    return bc19.Util.mr.move(bc19.Util.myp.dxTo(bc19.Util.p[xx][yy]), bc19.Util.myp.dyTo(bc19.Util.p[xx][yy]));
                                }
                            }
                        }
                ...
                bc19.Util.mr.log("Hggg");
                if (!Crusader.isItSafe(bc19.Util.myp)) {
                    Crusader.tryToGoToSafe();
                    if (Crusader.runAway != null) {
                        bc19.Util.mr.log("move(runaway2) a cru. x: " + Crusader.runAway.x + " y: " + Crusader.runAway.y);
                        return bc19.Util.mr.move(bc19.Util.myp.dxTo(Crusader.runAway), bc19.Util.myp.dyTo(Crusader.runAway));
                    }
                    else if (bc19.Util.attackTarget != null) {
                        bc19.Util.mr.log("stand and die by a cru. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
                    }
                }
            }
            else {
        ...
        /*private*/ Crusader.canAttack = function () {
            ...
            var po = null;
            {
                var array134 = bc19.Util.mr.getVisibleRobots();
                for (var index133 = 0; index133 < array134.length; index133++) {
                    var r = array134[index133];
                    {
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 16) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                value = 1;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                                value = 2;
        ...
        /*private*/ Crusader.checkFight = function () {
            var value = 0;
            var mx = 0;
            var mn = 10000;
            var mgx = 0;
            ...
            var pgo = null;
            {
                var array136 = bc19.Util.mr.getVisibleRobots();
                for (var index135 = 0; index135 < array136.length; index135++) {
                    var r = array136[index135];
                    {
                        ...
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) >= 16 && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 49) {
                            value = 0;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                                value = 2;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                            ...
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number())
                                value = 4;
                            if (value > mgx) {
                                pgo = bc19.Util.p[r.x][r.y];
                                mgx = value;
                            }
                        }
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 16) {
                            if (mn > bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                                poo = bc19.Util.p[r.x][r.y];
                                mn = bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]);
                            }
                        }
                    }
                }
            }
            bc19.Util.attackTarget = po;
            Crusader.followTarget = pgo;
            bc19.Util.dangerEnemy = poo;
        };
        /*private*/ Crusader.tryToGoToSafe = function () {
            Crusader.runAway = null;
            {
                var array138 = function () { var result = []; for (var val in bc19.Direction9) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index137 = 0; index137 < array138.length; index137++) {
                    var dir = array138[index137];
                    {
                        var po = bc19.Util.myp.dir9To(dir);
                        if (po != null && Crusader.canReach(po)) {
                            Crusader.runAway = po;
                            break;
                        }
                    }
            ...
            if (Crusader.runAway == null) {
                var array140 = function () { var result = []; for (var val in bc19.Direction9) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index139 = 0; index139 < array140.length; index139++) {
                    var dir = array140[index139];
                    {
                        var po = bc19.Util.myp.dir9To(dir);
                        if (po != null && Crusader.canHalfReach(po)) {
                            Crusader.runAway = po;
                            break;
                        }
                    }
        ...
        /*private*/ Crusader.canReach = function (po) {
            if (bc19.Util.myp.dist2$bc19_Point(po) <= 9 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2$bc19_Point(po) && Crusader.isItSafe(po))
                return true;
            return false;
        };
        /*private*/ Crusader.canHalfReach = function (po) {
            if (bc19.Util.myp.dist2$bc19_Point(po) <= 9 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2$bc19_Point(po) && Crusader.isItHalfSafe(po))
                return true;
            return false;
        };
        Crusader.isItSafe = function (po) {
            for (var index141 = 0; index141 < bc19.Util.seenO.length; index141++) {
                var ppo = bc19.Util.seenO[index141];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 26)
                        return false;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && po.dist2$bc19_Point(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                }
            }
            return true;
        };
        /*private*/ Crusader.isItHalfSafe = function (po) {
            for (var index142 = 0; index142 < bc19.Util.seenO.length; index142++) {
                var ppo = bc19.Util.seenO[index142];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 16)
                        return false;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && po.dist2$bc19_Point(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                }
    ...
    Crusader.runAway = null;
    Crusader.mode = 0;
    Crusader.followTarget = null;
    Crusader.madeByCastle = true;
    Crusader.firstIdiot = false;
    Crusader.firstDest = null;
...
(function (bc19) {
    var Pilgrim = (function (_super) {
        ...
        Pilgrim.turn = function (myRobot) {
            Pilgrim.giveItNow = false;
            bc19.Util.setupt(myRobot);
            if (bc19.Util.me.turn === 1) {
                {
                    var array144 = bc19.Util.mr.getVisibleRobots();
                    for (var index143 = 0; index143 < array144.length; index143++) {
                        var r = array144[index143];
                ...
                bc19.Util.resGoalP = ([]);
                for (var index145 = 0; index145 < bc19.Util.resP_$LI$().length; index145++) {
                    var po = bc19.Util.resP_$LI$()[index145];
                    {
                        if (bc19.Util.myp.distxy$bc19_Point(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
                }
                if (bc19.Util.resGoalP_$LI$().length > bc19.Util.seenIPilNear) {
                    Pilgrim.miner = true;
                }
            }
            if (Pilgrim.ret) {
                bc19.Util.resGoalP = ([]);
                for (var index146 = 0; index146 < bc19.Util.resP_$LI$().length; index146++) {
                    var po = bc19.Util.resP_$LI$()[index146];
                    {
                        if (bc19.Util.myp.distxy$bc19_Point(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
            ...
            Pilgrim.checkFight();
            if (Pilgrim.giveItNow) {
                Pilgrim.mypSafe = Pilgrim.isItSafe(bc19.Util.myp);
                if (Pilgrim.mypSafe) {
                    var gdir = Pilgrim.canGiveXXX();
                    if (gdir != null)
            ...
            if (Pilgrim.scouting) {
                if (bc19.Util.dangerEnemy == null && bc19.Util.attackTarget != null) {
                    if (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[bc19.Util.attackTarget.y][bc19.Util.attackTarget.x]).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                        var value = void 0;
                        var mx = 0;
                        for (var index147 = 0; index147 < bc19.Util.seenI.length; index147++) {
                            var po = bc19.Util.seenI[index147];
                            {
                                if (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[bc19.Util.attackTarget.y][bc19.Util.attackTarget.x]).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && mx < bc19.Util.myp.dist2$bc19_Point(po) && po.dist2$bc19_Point(bc19.Util.attackTarget) <= 64) {
                                    mx = bc19.Util.myp.dist2$bc19_Point(po);
                                }
                            }
                        }
                        value = bc19.Util.attackTarget.x + bc19.Util.attackTarget.y * bc19.Util.size + (5) * bc19.Util.size * bc19.Util.size;
                        bc19.Util.mr.signal(value, mx);
                    }
                }
                else if (bc19.Util.dangerEnemy == null && bc19.Util.attackTarget == null) {
                    if (!bc19.Util.mr.lastActionDone)
                    ...
                    if (bc19.Util.dest == null && Pilgrim.lastTry + 5 <= bc19.Util.me.turn) {
                        bc19.Util.mainPath = bc19.Nav.attEnemeyCastle();
                    ...
                    if (Pilgrim.runAway != null) {
                        ...
                        bc19.Util.mr.log("attack and die by a pilgrim. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
                    }
                }
                return null;
            }
            else if (!Pilgrim.miner) {
                {
                    if (!bc19.Util.mr.lastActionDone)
                        (bc19.Util.mainPath.push(Pilgrim.savePo) > 0);
                    if (bc19.Util.dest === bc19.Util.myp) {
                        bc19.Util.mr.log("WWWWWWWWWWWW: " + Pilgrim.gfe);
                        if (Pilgrim.nearestDep != null && bc19.Util.myp.distxy$bc19_Point(Pilgrim.nearestDep) <= 6) {
                            bc19.Util.mainPath = null;
                            bc19.Util.dest = null;
                            Pilgrim.gfe = false;
                            Pilgrim.expTarget = null;
                            Pilgrim.ret = true;
                            return null;
                        }
                        if (Pilgrim.gfe) {
                            Pilgrim.rBuildChurch1();
                            if (bc19.Util.mr.karbonite < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()].CONSTRUCTION_KARBONITE || bc19.Util.mr.fuel < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()].CONSTRUCTION_FUEL) {
                                bc19.Communication.encode(/* size */ bc19.Util.castlei_$LI$().length * 16 + 3 * 4, 0, 6);
                                bc19.Communication.castleOut();
                            }
                            if (Pilgrim.buildChurchPoint != null) {
                                bc19.Util.mainPath = null;
                                bc19.Util.dest = null;
                                bc19.Util.mr.log("build church by pilgrim. x,y: " + Pilgrim.buildChurchPoint);
                                Pilgrim.gfe = false;
                                Pilgrim.expTarget = null;
                                Pilgrim.ret = true;
                                return bc19.Util.mr.buildUnit(bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number(), bc19.Util.myp.dxTo(Pilgrim.buildChurchPoint), bc19.Util.myp.dyTo(Pilgrim.buildChurchPoint));
                            }
                            else {
                                Pilgrim.rBuildChurch();
                                if (Pilgrim.buildChurchPoint != null) {
                                    bc19.Util.mainPath = null;
                                    bc19.Util.dest = null;
                                    bc19.Util.mr.log("build church by pilgrim. x,y: " + Pilgrim.buildChurchPoint);
                    ...
                    bc19.Util.mr.log("hpo1");
                    Pilgrim.mypSafe = Pilgrim.isItSafe(bc19.Util.myp);
                    bc19.Util.mr.log("hpo2");
                    if (bc19.Util.mr.fuel === 0 || bc19.Util.mr.fuel < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].FUEL_PER_MOVE) {
                        return null;
                    }
                    bc19.Util.mr.log("hpo3");
                    if ((bc19.Util.dest == null || Pilgrim.recalc % 4 === 3) && Pilgrim.lastTry + 5 <= bc19.Util.me.turn) {
                        Pilgrim.recalc = 0;
                        Pilgrim.lastTryc = bc19.Util.me.turn;
                        {
                            if (Pilgrim.expTarget != null) {
                                bc19.Util.mainPath = bc19.Nav.AStarIsBack4p(Pilgrim.expTarget);
                            }
                            else {
                                Pilgrim.wantExp = true;
                                bc19.Communication.encode(/* size */ bc19.Util.castlei_$LI$().length * 16 + 2 * 4, 0, 6);
                                bc19.Communication.castleOut();
                                Pilgrim.gfe = true;
                                return null;
                            }
                    ...
                    bc19.Util.mr.log("hpo4");
                    if (bc19.Util.dest != null && bc19.Util.dest !== bc19.Util.myp) {
                        var po = (function (s) { return s[s.length - 1]; })(bc19.Util.mainPath);
                        if (po != null && Pilgrim.canReach(po)) {
                            /* pop */ bc19.Util.mainPath.pop();
                            Pilgrim.savePo = po;
                            Pilgrim.recalc = 0;
                        ...
                        if (po == null) {
                            var px = null;
                            {
                                var array149 = function () { var result = []; for (var val in bc19.Direction4) {
                                    if (!isNaN(val)) {
                                        result.push(parseInt(val, 10));
                                    }
                                } return result; }();
                                for (var index148 = 0; index148 < array149.length; index148++) {
                                    var dir = array149[index148];
                                    {
                                        var p2 = bc19.Util.myp.dir4To(dir);
                                        if (p2 != null && p2.passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                                            px = p2;
                                            break;
                                        }
                                    }
                            ...
                            if (px != null && Pilgrim.canReach(po)) {
                                bc19.Util.mr.log("random move a pilgram. x: " + px.x + " y: " + px.y);
                                return bc19.Util.mr.move(bc19.Util.myp.dxTo(px), bc19.Util.myp.dyTo(px));
                            }
                        }
                    }
                    if (!Pilgrim.mypSafe) {
                        Pilgrim.tryToGoToSafe();
                        if (Pilgrim.runAway != null) {
                            bc19.Util.mr.log("move(runaway) a pilgrim. x: " + Pilgrim.runAway.x + " y: " + Pilgrim.runAway.y);
                            return bc19.Util.mr.move(bc19.Util.myp.dxTo(Pilgrim.runAway), bc19.Util.myp.dyTo(Pilgrim.runAway));
                        }
                        else if (bc19.Util.attackTarget != null) {
                            bc19.Util.mr.log("stand and die by a pilgrim. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
                        }
                    }
                }
                ;
                ...
                if (Pilgrim.mypSafe) {
                    ...
                    if (Pilgrim.canMine()) {
                        Pilgrim.tryToGoToSafe();
                        if (Pilgrim.runAway != null) {
                            bc19.Util.mr.log("move(runaway1) a pilgrim. x: " + Pilgrim.runAway.x + " y: " + Pilgrim.runAway.y);
                            return bc19.Util.mr.move(bc19.Util.myp.dxTo(Pilgrim.runAway), bc19.Util.myp.dyTo(Pilgrim.runAway));
                        }
                        else if (bc19.Util.attackTarget != null) {
                            bc19.Util.mr.log("stand and die by a pilgrim. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
                ...
                if (!Pilgrim.mypSafe) {
                    Pilgrim.tryToGoToSafe();
                    if (Pilgrim.runAway != null) {
                        bc19.Util.mr.log("move(runaway2) a pilgrim. x: " + Pilgrim.runAway.x + " y: " + Pilgrim.runAway.y);
                        return bc19.Util.mr.move(bc19.Util.myp.dxTo(Pilgrim.runAway), bc19.Util.myp.dyTo(Pilgrim.runAway));
                    }
                    else if (bc19.Util.attackTarget != null) {
                        bc19.Util.mr.log("stand and die by a pilgrim. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
        ...
        /*private*/ Pilgrim.rBuildChurch1 = function () {
            Pilgrim.buildChurchPoint = null;
            bc19.Util.mr.log("build attempt");
            var po = Pilgrim.expTarget;
            if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()].CONSTRUCTION_FUEL)
                if (po != null && po.passable && !po.karbonite && !po.fuel && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0) {
                    Pilgrim.buildChurchPoint = po;
                }
        };
        /*private*/ Pilgrim.tryToGoToSafe = function () {
            Pilgrim.runAway = null;
            {
                var array151 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index150 = 0; index150 < array151.length; index150++) {
                    var dir = array151[index150];
                    {
            ...
            if (Pilgrim.runAway == null) {
                var array153 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index152 = 0; index152 < array153.length; index152++) {
                    var dir = array153[index152];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && Pilgrim.canHalfReach(po)) {
                            Pilgrim.runAway = po;
                            break;
                        }
                    }
        ...
        /*private*/ Pilgrim.rBuildChurch = function () {
            Pilgrim.buildChurchPoint = null;
            bc19.Util.mr.log("build attempt");
            if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()].CONSTRUCTION_FUEL) {
                var array155 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index154 = 0; index154 < array155.length; index154++) {
                    var dir = array155[index154];
                    {
                        var po = bc19.Util.myp.dirTo(dir);
                        if (po != null && po.passable && !po.karbonite && !po.fuel && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0) {
                            Pilgrim.buildChurchPoint = po;
                            break;
                        }
        ...
        /*private*/ Pilgrim.justRunAway = function () {
            Pilgrim.runAway = null;
            if (bc19.Util.mr.getRobot(bc19.Util.dangerEnemyId).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                {
                    ...
                    for (var index156 = 0; index156 < array157.length; index156++) {
                        ...
                        {
                            var po = bc19.Util.myp.dir4To(dir);
                            if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2$bc19_Point(bc19.Util.dangerEnemy) > 26) {
                                Pilgrim.runAway = po;
                                break;
                            }
                        }
            ...
            }
            {
                ...
                for (var index158 = 0; index158 < array159.length; index158++) {
                    ...
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2$bc19_Point(bc19.Util.dangerEnemy) > bc19.Util.mr.SPECS.UNITS[bc19.Util.mr.getRobot(bc19.Util.dangerEnemyId).unit].VISION_RADIUS) {
                            Pilgrim.runAway = po;
                            break;
                        }
                    }
            ...
            {
                var array161 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index160 = 0; index160 < array161.length; index160++) {
                    var dir = array161[index160];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2$bc19_Point(bc19.Util.dangerEnemy) > bc19.Util.mr.SPECS.UNITS[bc19.Util.mr.getRobot(bc19.Util.dangerEnemyId).unit].ATTACK_RADIUS[1]) {
                            Pilgrim.runAway = po;
                            break;
                        }
                    }
        ...
        /*private*/ Pilgrim.canReach = function (po) {
            if (bc19.Util.myp.dist2$bc19_Point(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2$bc19_Point(po) && Pilgrim.isItSafe(po))
                return true;
            return false;
        };
        /*private*/ Pilgrim.canHalfReach = function (po) {
            if (bc19.Util.myp.dist2$bc19_Point(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2$bc19_Point(po) && Pilgrim.isItHalfSafe(po))
                return true;
            return false;
        };
        /*private*/ Pilgrim.safeToGo = function (po) {
            if (bc19.Util.attackTarget == null || (po.dist2$bc19_Point(bc19.Util.attackTarget) > bc19.Util.mr.SPECS.UNITS[bc19.Util.attackTargetR.unit].VISION_RADIUS && (bc19.Util.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number() || bc19.Util.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Crusader].number())) || (po.dist2$bc19_Point(bc19.Util.attackTarget) > 26 && bc19.Util.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()))
                return true;
            return false;
        };
        Pilgrim.isItSafe = function (po) {
            for (var index162 = 0; index162 < bc19.Util.seenO.length; index162++) {
                var ppo = bc19.Util.seenO[index162];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 26)
                    ...
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && po.dist2$bc19_Point(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                    if (po.dist2$bc19_Point(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].VISION_RADIUS)
                        return false;
                }
            }
            return true;
        };
        /*private*/ Pilgrim.isItHalfSafe = function (po) {
            for (var index163 = 0; index163 < bc19.Util.seenO.length; index163++) {
                var ppo = bc19.Util.seenO[index163];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 16)
                    ...
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && po.dist2$bc19_Point(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                    if (po.dist2$bc19_Point(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                }
            }
            return true;
        ...
        /*private*/ Pilgrim.checkFight = function () {
            Pilgrim.nearestDep = null;
            bc19.Util.dangerEnemyId = -1;
            bc19.Util.attackTargetR = null;
            var value = 0;
            var mx = 0;
            var mn = 10000;
            var mns = 100000;
            ...
            var pp;
            {
                var array165 = bc19.Util.mr.getVisibleRobots();
                for (var index164 = 0; index164 < array165.length; index164++) {
                    var r = array165[index164];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        pp = bc19.Util.p[r.x][r.y];
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(pp) <= 100) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                value = 1;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                                value = 2;
                            ...
                            if (value > mx) {
                                po = pp;
                                mx = value;
                                bc19.Util.attackTargetR = r;
                            }
                        }
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && ((bc19.Util.myp.dist2$bc19_Point(pp) <= bc19.Util.mr.SPECS.UNITS[r.unit].VISION_RADIUS && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number() && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) || (bc19.Util.myp.dist2$bc19_Point(pp) <= 26 && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()))) {
                            if (mn > bc19.Util.myp.dist2$bc19_Point(pp)) {
                                poo = pp;
                                bc19.Util.dangerEnemyId = r.id;
                                mn = bc19.Util.myp.dist2$bc19_Point(pp);
                            }
                        }
                    }
                }
            }
            for (var index166 = 0; index166 < bc19.Util.seenIR.length; index166++) {
                var r = bc19.Util.seenIR[index166];
                {
                    pp = bc19.Util.p[r.x][r.y];
                    if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() || r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()) {
                        if (mns > bc19.Util.myp.distxy$bc19_Point(pp)) {
                            Pilgrim.nearestDep = pp;
                            mns = bc19.Util.myp.distxy$bc19_Point(pp);
                        }
                    }
                }
            }
        ...
        /*private*/ Pilgrim.canGive = function () {
            {
                var array168 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
        ...
        /*private*/ Pilgrim.canGiveXXX = function () {
            {
                var array170 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index169 = 0; index169 < array170.length; index169++) {
                    ...
                    {
                        var p2 = bc19.Util.myp.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] > 0 && (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x]).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() || bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x]).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()) && (bc19.Util.me.karbonite !== 0 || bc19.Util.me.fuel !== 0)) {
                            return dir;
                        }
                    }
                }
        ...
        /*private*/ Pilgrim.canMove = function () {
            ...
            var ddir = null;
            {
                var array172 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index171 = 0; index171 < array172.length; index171++) {
                    var dir = array172[index171];
                    {
                        var p2 = bc19.Util.myp.dirTo(dir);
        ...
        /*private*/ Pilgrim.canMine = function () {
            return (((bc19.Util.myp.karbonite && bc19.Util.me.karbonite !== 20) || (bc19.Util.myp.fuel && bc19.Util.me.fuel !== 100)) && bc19.Util.mr.fuel >= 1);
        };
        return Pilgrim;
    }(bc19.Util));
    Pilgrim.savePo = null;
...
(function (bc19) {
    var Castle = (function (_super) {
        ...
        Castle.lookInProg_$LI$ = function () { if (Castle.lookInProg == null)
            Castle.lookInProg = ([]); return Castle.lookInProg; };
        ;
        Castle.doneDep_$LI$ = function () { if (Castle.doneDep == null)
            Castle.doneDep = ([]); return Castle.doneDep; };
        ;
        Castle.turn = function (myRobot) {
            Castle.stopUsingRes = false;
            Castle.pullNow = false;
            bc19.Util.setupt(myRobot);
            if (bc19.Util.me.turn % 200 === 0)
                Castle.rushSize = 4;
            if (bc19.Util.me.turn === 1) {
                Castle.estlen = bc19.Util.myp.distxy$bc19_Point(bc19.Util.revPoint(bc19.Util.myp));
                bc19.Util.myCC = bc19.Util.myp;
                {
                    var array174 = bc19.Util.mr.getVisibleRobots();
                    for (var index173 = 0; index173 < array174.length; index173++) {
                        var r = array174[index173];
                        {
                ...
                for (var index175 = 0; index175 < bc19.Util.resP_$LI$().length; index175++) {
                    var po = bc19.Util.resP_$LI$()[index175];
                    {
                        if (bc19.Util.myp.distxy$bc19_Point(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
                }
                var pp = bc19.Util.myp;
                if (!pp.icastle && pp.icastleNotDes) {
                    pp.icastle = true;
                    /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                        s.push(e);
                        ...
                        return false;
                    } })(bc19.Util.castlei_$LI$(), pp);
                }
                var pr = bc19.Util.revPoint(pp);
                if (!pr.ocastle && pr.ocastleNotDes) {
                    pr.ocastle = true;
                    /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                        s.push(e);
                        ...
                        return false;
                    } })(bc19.Util.castleo_$LI$(), pr);
                }
            }
            Castle.goodTimeForRush();
            bc19.Communication.turn();
            ...
            Castle.checkFight();
            for (var index176 = 0; index176 < bc19.Util.knownRListChu_$LI$().length; index176++) {
                var iid = bc19.Util.knownRListChu_$LI$()[index176];
                {
                    if (bc19.Util.allKnownR_$LI$()[iid] === true) {
                        if (bc19.Util.lastKnownR_$LI$()[iid] !== bc19.Util.me.turn) {
                            var _loop_1 = function (index177) {
                                var lip = Castle.lookInProg_$LI$()[index177];
                                {
                                    if (lip == null)
                                        return "continue";
                                    if (lip.dist2$int$int(bc19.Util.xr_$LI$()[iid], bc19.Util.yr_$LI$()[iid]) <= 9) {
                                        /* remove */ (function (a) { return a.splice(a.indexOf(lip), 1); })(Castle.lookInProg_$LI$());
                                        return "break";
                                    }
                                }
                            };
                            for (var index177 = 0; index177 < Castle.lookInProg_$LI$().length; index177++) {
                                var state_1 = _loop_1(index177);
                                if (state_1 === "break")
                                    break;
                            }
                            bc19.Util.allKnownR_$LI$()[iid] = false;
                        }
                    }
                }
            }
            if (bc19.Util.me.turn === 3) {
                Castle.appx = bc19.Util.castlei_$LI$().length;
            }
            Castle.estFighter = Math.max(Castle.unitNum - (bc19.Util.resP_$LI$().length / 2 | 0), 0);
            Castle.needForDef = false;
            Castle.ut = Castle.nextUnit();
            Castle.cpu = Castle.canProduceUnit();
            Castle.needRes = false;
            if (Castle.ut === bc19.UnitType.Preacher && Castle.cpu != null && (bc19.Util.mr.karbonite < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Castle.ut].number()].CONSTRUCTION_KARBONITE || bc19.Util.mr.fuel < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Castle.ut].number()].CONSTRUCTION_FUEL) && Castle.needForDef)
                Castle.needRes = true;
            if (Castle.needRes) {
                bc19.Communication.cmessage = 3 * 4;
                if (bc19.Util.seenO.length > 2)
                    bc19.Communication.cmessage = 3 * 4 + 2;
                bc19.Communication.castleOut();
            }
            if (bc19.Util.attackTarget != null && (Castle.ut == null || (Castle.ut !== bc19.UnitType.Preacher && (Castle.ut !== bc19.UnitType.Prophet || bc19.Util.myp.dist2$bc19_Point(bc19.Util.attackTarget) <= 16)) || Castle.cpu == null || bc19.Util.mr.karbonite < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Castle.ut].number()].CONSTRUCTION_KARBONITE || bc19.Util.mr.fuel < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Castle.ut].number()].CONSTRUCTION_FUEL)) {
                bc19.Util.mr.log("attack by a castle. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
                return bc19.Util.mr.attack(bc19.Util.myp.dxTo(bc19.Util.attackTarget), bc19.Util.myp.dyTo(bc19.Util.attackTarget));
            }
            else {
                if (Castle.ut != null && bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Castle.ut].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Castle.ut].number()].CONSTRUCTION_FUEL && Castle.cpu != null) {
                    Castle.assign();
                    if (Castle.assignNode == null) {
                        ...
                        if (Castle.ut === bc19.UnitType.Pilgrim)
                            ...
                            bc19.Util.pre++;
                        else if (Castle.ut === bc19.UnitType.Prophet)
                            bc19.Util.pro++;
                        else if (Castle.ut === bc19.UnitType.Crusader)
                            bc19.Util.cru++;
        ...
        /*private*/ Castle.assign = function () {
            ...
            Castle.assignDir = Castle.cpu;
            if (Castle.ut === bc19.UnitType.Pilgrim && bc19.Util.me.turn < 100) {
                bc19.Util.mainPath = bc19.Nav.nextAssignRes();
                if (bc19.Util.mainPath != null && bc19.Util.mainPath.length !== 0) {
                    Castle.assignNode = bc19.Util.mainPath.pop();
                }
            }
            else if (Castle.ut === bc19.UnitType.Crusader) {
                bc19.Util.mainPath = bc19.Nav.nextAssignDefPro();
                if (bc19.Util.mainPath != null && bc19.Util.mainPath.length !== 0) {
                    Castle.assignNode = bc19.Util.mainPath.pop();
                }
            }
            else if (Castle.ut === bc19.UnitType.Prophet) {
                bc19.Util.mainPath = bc19.Nav.nextAssignDefBackProX();
                if (bc19.Util.mainPath != null && bc19.Util.mainPath.length !== 0) {
                    Castle.assignNode = bc19.Util.mainPath.pop();
                }
            }
            else if (Castle.ut === bc19.UnitType.Preacher) {
                bc19.Util.mainPath = bc19.Nav.nextAssignDefPre();
                if (bc19.Util.mainPath != null && bc19.Util.mainPath.length !== 0) {
                    Castle.assignNode = bc19.Util.mainPath.pop();
                }
            }
        ...
        /*private*/ Castle.nextUnit = function () {
            var uu = null;
            if (Castle.appx === 1) {
                uu = Castle.goForHaras();
                if (uu != null)
                    return uu;
                if (bc19.Util.pre === 0 && bc19.Util.mr.karbonite >= 30 && bc19.Util.mr.karbonite < 40 && bc19.Util.mr.fuel >= 50) {
                    return bc19.UnitType.Preacher;
                }
                uu = Castle.goForDef();
                if (uu != null)
                    return uu;
                if (Castle.stopUsingRes)
                    return null;
                uu = Castle.goForRes();
                if (uu != null)
                    return uu;
                ...
                if (uu != null)
                    return uu;
                uu = Castle.readyForDef();
                if (uu != null)
                    return uu;
                uu = Castle.readyForPush();
                if (uu != null)
                    return uu;
                uu = Castle.goForExp();
                if (uu != null)
        ...
        /*private*/ Castle.goForDef = function () {
            if (bc19.Util.seenO.length !== 0 && bc19.Util.seenIPreNear + bc19.Util.seenIProNear < bc19.Util.seenO.length) {
                if (bc19.Util.seenIPreNear <= 2 * bc19.Util.seenIProNear && (bc19.Util.me.health === 200 || bc19.Util.pro !== 0)) {
                    if (bc19.Util.mr.karbonite !== 25) {
                        Castle.needForDef = true;
                        return bc19.UnitType.Preacher;
                    }
                    else
                        return bc19.UnitType.Prophet;
                }
                else {
                    if (bc19.Util.myp.dist2$bc19_Point(bc19.Util.attackTarget) <= 16 && bc19.Util.mr.karbonite >= 30)
                        return bc19.UnitType.Preacher;
                    else
                        return bc19.UnitType.Prophet;
                }
        ...
        /*private*/ Castle.goForRes = function () {
            if (bc19.Util.seenIPilNear < bc19.Util.resGoalP_$LI$().length && (bc19.Util.pil < 2 || bc19.Util.mr.karbonite >= 40 && bc19.Util.mr.fuel >= 100) && bc19.Util.seenO.length === 0)
                return bc19.UnitType.Pilgrim;
            return null;
        };
        /*private*/ Castle.readyForDef = function () {
            if (Castle.enAttack !== 0) {
                if (Castle.enAttackPro === 0) {
                    if (bc19.Util.seenIPreNear + bc19.Util.seenIProNear < Castle.enAttack)
                        if (bc19.Util.seenIPreNear <= 2 * bc19.Util.seenIProNear && (bc19.Util.me.health === 200 || bc19.Util.pro !== 0)) {
                            return bc19.UnitType.Preacher;
                        }
                        else if (bc19.Util.seenIProNear < 4) {
                            return bc19.UnitType.Prophet;
                        }
                }
                else {
                    if (bc19.Util.seenIPreNear + bc19.Util.seenIProNear < Castle.enAttack)
                        ...
                        else if (bc19.Util.seenIProNear < Math.max(Castle.enAttackPro + 3, 10)) {
                            return bc19.UnitType.Prophet;
                        }
                }
            }
            else if (bc19.Util.me.turn >= 150) {
                if (bc19.Util.mr.karbonite >= 50 + 25 && bc19.Util.mr.fuel >= 200 + 50 && bc19.Util.seenIProNear < 3)
                    return bc19.UnitType.Prophet;
                if (bc19.Util.pro < bc19.Util.seenO.length && bc19.Util.mr.karbonite >= 25 && bc19.Util.mr.fuel >= 50)
                    return bc19.UnitType.Prophet;
                if (bc19.Util.pro < 3 && bc19.Util.mr.karbonite >= 35 && bc19.Util.mr.fuel >= 100 && bc19.Util.me.turn > 20)
                    return bc19.UnitType.Prophet;
            }
            return null;
        };
        /*private*/ Castle.readyForPush = function () {
            if (bc19.Util.me.turn >= 20) {
                if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_KARBONITE + 10 && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_FUEL + 10 && (bc19.Util.pre % Castle.rushSize !== Castle.rushSize || (bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].FUEL_PER_MOVE * Castle.estlen * Math.max(Castle.estFighter, Castle.rushSize * Castle.appx)))) {
                    return bc19.UnitType.Preacher;
                }
                else {
                    if (bc19.Util.mr.karbonite >= 50 + 25 && bc19.Util.mr.fuel >= 200 + 50 && bc19.Util.seenIProNear < 3)
            ...
            if (bc19.Util.me.turn >= 150) {
            }
            return null;
        };
        /*private*/ Castle.goForHaras = function () {
            if (bc19.Util.me.turn === 1) {
                var etx = bc19.Nav.expandTargetXXX();
                bc19.Util.mr.log("etx: " + etx);
                if (etx != null) {
                    bc19.Util.mr.log("etx: " + ((bc19.Util.myp.distxy$bc19_Point(bc19.Util.revPoint(etx)) / 3 | 0)) + " - " + ((bc19.Util.myp.distxy$bc19_Point(etx) / 2 | 0)));
                    if ((bc19.Util.myp.distxy$bc19_Point(bc19.Util.revPoint(etx)) / 3 | 0) <= (bc19.Util.myp.distxy$bc19_Point(etx) / 2 | 0))
                        return bc19.UnitType.Crusader;
                }
            }
            return null;
        };
        /*private*/ Castle.goForExp = function () {
            if (bc19.Util.seenIPilNear >= bc19.Util.resGoalP_$LI$().length && Castle.pili < 8 && bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].CONSTRUCTION_FUEL && (Castle.lastPili === -1 || bc19.Util.me.turn > Castle.lastPili + 10)) {
                if (bc19.Nav.expandTargetXXX() != null && (bc19.Util.pre >= 1 || bc19.Util.mr.karbonite >= 40 && bc19.Util.mr.fuel >= 100) && bc19.Util.seenO.length === 0) {
                    Castle.lastPili = bc19.Util.me.turn;
                    Castle.pili++;
                    return bc19.UnitType.Pilgrim;
                }
            }
        ...
        /*private*/ Castle.goForHp = function () {
            if (bc19.Util.me.turn >= 800) {
                var dp = bc19.Util.mr.karbonite / 15 - bc19.Util.mr.fuel / 50;
                var dc = bc19.Util.mr.fuel / 25 - bc19.Util.mr.karbonite / 15;
                if (dp >= dc)
                    return bc19.UnitType.Preacher;
                else
                    return bc19.UnitType.Crusader;
        ...
        /*private*/ Castle.goodTimeForRush = function () {
            {
                if (bc19.Communication.smessage % 16 === 11 || bc19.Communication.smessage % 16 === 9 || bc19.Communication.smessage % 16 === 8 || bc19.Communication.smessage % 16 === 7)
                    Castle.wave = 0;
                if (bc19.Util.me.turn < 800 && bc19.Util.pre !== 0 && bc19.Util.pre % Castle.rushSize === 0 && !Castle.vwave) {
                    Castle.wave = Castle.rushSize;
                    Castle.vwave = true;
                    Castle.rpre = bc19.Util.pre;
                }
                else if (Castle.rpre !== bc19.Util.pre) {
                    Castle.vwave = false;
                }
            }
            ;
        ...
        /*private*/ Castle.checkFight = function () {
            ...
            var po = null;
            var poo = null;
            for (var index178 = 0; index178 < bc19.Util.seenOR.length; index178++) {
                var r = bc19.Util.seenOR[index178];
                {
                    if (bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 64) {
                        if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                            value = 1;
                        if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                            value = 2;
                        ...
                        if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number())
                            value = 5;
                        value = 100 * value - bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]);
                        if (value > mx) {
                            po = bc19.Util.p[r.x][r.y];
                            mx = value;
                        }
                    }
                    if (bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 100) {
                        if (mn > bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y])) {
                            poo = bc19.Util.p[r.x][r.y];
                            mn = bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]);
                        }
                    }
            ...
            bc19.Util.attackTarget = po;
            bc19.Util.dangerEnemy = poo;
            Castle.enAttack = Math.max(Castle.enAttack, /* size */ bc19.Util.seenO.length);
            Castle.enAttackPro = Math.max(Castle.enAttackPro, bc19.Util.seenOPre);
        };
        ...
        /*private*/ Castle.canProduceUnit = function () {
            ...
            {
                var array180 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index179 = 0; index179 < array180.length; index179++) {
                    var dir = array180[index179];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                            return dir;
        ...
        /*private*/ Castle.produceNewUnit = function (unitType) {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array182 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
...
(function (bc19) {
    var Communication = (function (_super) {
                ...
                for (var index183 = 0; index183 < array184.length; index183++) {
                    var r = array184[index183];
                    {
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number()) {
                            ...
                            bc19.Util.lastKnownR_$LI$()[r.id] = bc19.Util.me.turn;
                        }
                    }
                }
            }
        ...
        /*private*/ Communication.handleCastleIn = function (r) {
            ...
            var oopcode = Communication.decode(r.castle_talk, 0, 4);
            if (opcode === 0) {
                if (Communication.decode(r.castle_talk, 0, 4) === 4 * 1) {
                    if (bc19.Util.me.turn >= 3) {
                        if ((function (m) { if (m.entries == null)
                            ...
                            if (bc19.Util.mr.isVisible(r) && bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp) <= 100 && bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp) > Communication.maxSignalRange) {
                                Communication.maxSignalRange = bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp);
                            }
                        }
                        else {
                            if (bc19.Util.mr.isVisible(r) && bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp) <= 100 && bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp) > Communication.maxSignalRangeM) {
                                Communication.maxSignalRangeM = bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp);
                            }
                        }
                    }
                }
                else if (Communication.decode(r.castle_talk, 0, 4) === 4 * 2) {
                    if (bc19.Util.mr.isVisible(r) && bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp) <= 100 && bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp) > Communication.maxSignalRangeExpand) {
                        Communication.maxSignalRangeExpand = bc19.Util.p[r.x][r.y].dist2$bc19_Point(bc19.Util.myp);
                    }
                }
                else if (Communication.decode(r.castle_talk, 0, 4) === 4 * 3) {
                    {
                        bc19.Castle.stopUsingRes = true;
                    }
                    ;
                }
            }
            else if (opcode === 1) {
                if (!bc19.Util.allKnownR_$LI$()[r.id]) {
                    bc19.Util.allKnownR_$LI$()[r.id] = true;
                    bc19.Util.typeKnownR_$LI$()[r.id] = bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number();
                    /* add */ (bc19.Util.knownRList_$LI$().push(r.id) > 0);
                }
                if (bc19.Util.allKnownR_$LI$()[r.id])
                    if (bc19.Util.typeKnownR_$LI$()[r.id] === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                        if (!(function (m, k) { if (m.entries == null)
                            m.entries = []; for (var i = 0; i < m.entries.length; i++)
                            if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                return true;
                            } return false; })(bc19.Util.xid_$LI$(), r.id)) {
                            bc19.Util.xr_$LI$()[r.id] = Communication.decode(r.castle_talk, 2, 8);
                            ...
                            bc19.Util.yr_$LI$()[r.id] = Communication.decode(r.castle_talk, 2, 8);
                            /* put */ (function (m, k, v) { if (m.entries == null)
                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                    m.entries[i].value = v;
                            ...
                            var pp = bc19.Util.p[(function (m, k) { if (m.entries == null)
                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                    return m.entries[i].value;
                                } return null; })(bc19.Util.xid_$LI$(), r.id)][Communication.decode(r.castle_talk, 2, 8)];
                            if (!pp.icastle && pp.icastleNotDes) {
                                pp.icastle = true;
                                /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                                    s.push(e);
                ...
                if (Communication.decode(r.castle_talk, 2, 4) === 0) {
                    bc19.Util.allKnownR_$LI$()[r.id] = true;
                    bc19.Util.typeKnownR_$LI$()[r.id] = Communication.decode(r.castle_talk, 4, 7);
                    /* add */ (bc19.Util.knownRList_$LI$().push(r.id) > 0);
                    bc19.Util.xr_$LI$()[r.id] = -1;
                    bc19.Util.yr_$LI$()[r.id] = -1;
                    if (bc19.Util.typeKnownR_$LI$()[r.id] === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                        (bc19.Util.knownRListChu_$LI$().push(r.id) > 0);
                    if (Communication.decode(r.castle_talk, 7, 8) === 1) {
                        bc19.Castle.pullNow = true;
                        bc19.Castle.stopUsingRes = true;
                    }
                }
                else if (Communication.decode(r.castle_talk, 2, 4) === 1) {
                }
                else if (Communication.decode(r.castle_talk, 2, 4) === 2) {
                }
                else if (Communication.decode(r.castle_talk, 2, 4) === 3) {
                    {
                        bc19.Castle.stopUsingRes = true;
                        bc19.Castle.pullNow = true;
                    }
        ...
        Communication.decode = function (code, start, end) {
            return ((code / (Math.pow(2, start) | 0) | 0)) % (Math.pow(2, end - start) | 0);
        };
        Communication.encode = function (code, start, end) {
        ...
        Communication.signalInPreacher = function () {
            ...
            {
                var array186 = bc19.Util.mr.getVisibleRobots();
                for (var index185 = 0; index185 < array186.length; index185++) {
                    var r = array186[index185];
                    {
        ...
        /*private*/ Communication.handleSignalInPreacher = function (r) {
            ...
            if (opcode === 5) {
                ...
                var pp = bc19.Util.p[Communication.decode(r.signal, 10, 16)][Communication.decode(r.signal, 4, 10)];
                if (!pp.icastle && pp.icastleNotDes) {
                    pp.icastle = true;
                    /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                        s.push(e);
                ...
                if (bc19.Preacher.mode === 0 || bc19.Preacher.mode === 2)
                    Communication.encode(/* size */ bc19.Util.castlei_$LI$().length * 16 + 1 * 4, 0, 6);
                else
                ...
                if (bc19.Preacher.mode !== 1) {
                    bc19.Preacher.lastmode = bc19.Preacher.mode;
                    bc19.Preacher.mode = 2;
                    bc19.Util.kkp = bc19.Util.p[Communication.decode(r.signal, 10, 16)][Communication.decode(r.signal, 4, 10)];
                }
            }
        };
        Communication.signalOutCastle = function () {
            var v = false;
            for (var index187 = 0; index187 < bc19.Util.seenOR.length; index187++) {
                var r = bc19.Util.seenOR[index187];
                {
                    var po = bc19.Util.p[r.x][r.y];
                    if (po == null || r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number())
                        continue;
                    v = true;
                    for (var index188 = 0; index188 < bc19.Util.seenIPreP.length; index188++) {
                        var pp = bc19.Util.seenIPreP[index188];
                        {
                            if (pp == null)
                                continue;
                            if (po.dist2$bc19_Point(pp) <= 16) {
                                v = false;
                                break;
                            }
                            if (bc19.Util.myp.dist2$bc19_Point(pp) <= 16)
                                Communication.msq = Math.max(Communication.msq, bc19.Util.myp.dist2$bc19_Point(pp));
                        }
                    }
                    if (v && bc19.Util.seenIPre !== 0) {
                        Communication.smessage = po.x * (Math.pow(2, 10) | 0) + po.y * (Math.pow(2, 4) | 0) + 13;
                        break;
                    }
                }
            }
            if (Communication.msq !== 0 && v && bc19.Util.seenIPre !== 0 && Communication.smessage % 16 === 13) {
                return;
            }
            else {
                if (bc19.Castle.pullNow) {
                    Communication.smessage = 12;
                    Communication.mss = 2;
                }
                else {
                    if (Communication.maxSignalRangeExpand !== 0) {
                        bc19.Castle.expTarget = bc19.Nav.expandTargetXXX();
                        if (bc19.Castle.expTarget != null) {
                            Communication.smessage = bc19.Castle.expTarget.x * (Math.pow(2, 10) | 0) + bc19.Castle.expTarget.y * (Math.pow(2, 4) | 0) + 10;
                            /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                                s.push(e);
                                return true;
                            }
                                ...
                                return false;
                            } })(bc19.Castle.lookInProg_$LI$(), bc19.Castle.expTarget);
                        }
                    }
                    else {
                        if (Communication.maxSignalRangeM !== 0 && bc19.Castle.wave !== 0) {
                            bc19.Util.mr.log("HH2");
                            if (bc19.Util.me.turn >= 150) {
                                if (Communication.maxSignalRange === 0) {
                                    Communication.smessage = 9;
                                }
                                else {
                                    bc19.Util.mr.log("HH3");
                                    if ((function (m) { if (m.entries == null)
                                        m.entries = []; return m.entries.length; })(bc19.Util.xid_$LI$()) === 2) {
                                        var t = bc19.Util.me.turn % 2;
                                        {
                                            var array190 = (function (m) { var r = []; if (m.entries == null)
                                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                                r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                                            for (var index189 = 0; index189 < array190.length; index189++) {
                                                var id = array190[index189];
                                                {
                                                    if (t === 0) {
                                                        Communication.smessage = (function (m, k) { if (m.entries == null)
                                                            ...
                                                            if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                                                return m.entries[i].value;
                                                            } return null; })(bc19.Util.yid_$LI$(), id) * (Math.pow(2, 4) | 0) + 11;
                                                        break;
                                                    }
                                                    t--;
                                                }
                                        ...
                                        {
                                            var array192 = (function (m) { var r = []; if (m.entries == null)
                                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                                r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                                            for (var index191 = 0; index191 < array192.length; index191++) {
                                                var id = array192[index191];
                                                {
                                                    Communication.smessage = (function (m, k) { if (m.entries == null)
                                                        m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                                        if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                ...
                                if (Communication.maxSignalRange === 0) {
                                    ...
                                    if ((function (m) { if (m.entries == null)
                                        ...
                                        m.entries = []; return m.entries.length; })(bc19.Util.xid_$LI$()) === 1) {
                                        {
                                            var array196 = (function (m) { var r = []; if (m.entries == null)
                                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                                r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                                            for (var index195 = 0; index195 < array196.length; index195++) {
                                                var id = array196[index195];
                                                {
                                                    Communication.smessage = (function (m, k) { if (m.entries == null)
                                                        m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                                        if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                            ...
                            if ((function (m) { if (m.entries == null)
                                ...
                                m.entries = []; return m.entries.length; })(bc19.Util.xid_$LI$()) === 1) {
                                {
                                    var array200 = (function (m) { var r = []; if (m.entries == null)
                                        m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                        r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                                    for (var index199 = 0; index199 < array200.length; index199++) {
                                        var id = array200[index199];
                                        {
                                            Communication.smessage = (function (m, k) { if (m.entries == null)
                                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                                if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
        ...
        Communication.signalOut = function () {
            if (Communication.msq !== 0) {
                bc19.Util.mr.signal(Communication.smessage, Communication.msq);
                bc19.Util.mr.log("signal : " + Communication.smessage + " - " + (Communication.smessage % 16) + " - " + Communication.msq);
            }
            else {
                if (Communication.mss !== 0) {
                    bc19.Util.mr.signal(Communication.smessage, Communication.mss);
                    bc19.Util.mr.log("signal : " + Communication.smessage + " - " + (Communication.smessage % 16) + " - " + Communication.mss);
                }
                else {
                    if (Communication.maxSignalRangeExpand !== 0) {
                        bc19.Util.mr.signal(Communication.smessage, Communication.maxSignalRangeExpand);
                        bc19.Util.mr.log("signal : " + Communication.smessage + " - " + (Communication.smessage % 16) + " - " + Communication.maxSignalRangeExpand);
                    }
                    else {
                        if (Communication.maxSignalRangeM !== 0 && bc19.Castle.wave !== 0) {
                            bc19.Util.mr.signal(Communication.smessage, Math.max(Communication.maxSignalRangeM, Communication.maxSignalRange));
                            bc19.Util.mr.log("signal : " + Communication.smessage + " - " + (Communication.smessage % 16) + " - " + Math.max(Communication.maxSignalRangeM, Communication.maxSignalRange));
                        }
                        else if (Communication.maxSignalRange !== 0) {
                            bc19.Util.mr.signal(Communication.smessage, Communication.maxSignalRange);
                            bc19.Util.mr.log("signal : " + Communication.smessage + " - " + (Communication.smessage % 16) + " - " + Communication.maxSignalRange);
                        }
                    }
                }
            }
        ...
        Communication.signalInPilgrim = function () {
            ...
            bc19.Preacher.stopCommand = false;
            {
                var array202 = bc19.Util.mr.getVisibleRobots();
                for (var index201 = 0; index201 < array202.length; index201++) {
                    var r = array202[index201];
                    {
                        if (!bc19.Util.mr.isRadioing(r) || (bc19.Util.mr.isVisible(r) && bc19.Util.mr.getRobot(r.id).team !== bc19.Team["_$wrappers"][bc19.Util.teami].number()))
                            continue;
        ...
        /*private*/ Communication.handleSignalInPilgrim = function (r) {
            ...
            if (opcode === 5) {
                ...
                bc19.Pilgrim.expTarget = bc19.Util.p[Communication.decode(r.signal, 10, 16)][Communication.decode(r.signal, 4, 10)];
                bc19.Pilgrim.wantExp = false;
                Communication.encode(/* size */ bc19.Util.castlei_$LI$().length * 16 + 1 * 4, 0, 6);
            }
            else if (opcode === 12) {
                bc19.Pilgrim.giveItNow = true;
            }
            if (bc19.Pilgrim.wantExp && bc19.Pilgrim.expTarget == null) {
                Communication.encode(/* size */ bc19.Util.castlei_$LI$().length * 16 + 2 * 4, 0, 6);
            }
        };
        Communication.signalInProphet = function () {
            {
                var array204 = bc19.Util.mr.getVisibleRobots();
                for (var index203 = 0; index203 < array204.length; index203++) {
                    var r = array204[index203];
                    {
                        if (!bc19.Util.mr.isRadioing(r) || (bc19.Util.mr.isVisible(r) && bc19.Util.mr.getRobot(r.id).team !== bc19.Team["_$wrappers"][bc19.Util.teami].number()))
                            continue;
                        Communication.handleSignalInProphet(r);
                        if (r.id !== bc19.Util.me.id)
                            bc19.Util.mr.log("sz :" + r.id + " - " + r.signal);
                    }
                }
        ...
        /*private*/ Communication.handleSignalInProphet = function (r) {
            var opcode = Communication.decode(r.signal, 0, 4);
            if (opcode === 5) {
            }
            else if (opcode === 6) {
...
(function (bc19) {
    var Nav = (function (_super) {
        ...
        Nav.destSetPilgrimToResource = function () {
            ...
            bc19.Util.mr.log("here");
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array206 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index205 = 0; index205 < array206.length; index205++) {
                        var dir = array206[index205];
                        {
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 || (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) && (bc19.Util.myp !== po || (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && bc19.Pilgrim.isItSafe(pi)))) {
                                if (pi.fuel && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) {
                                    value = -pi.dist2$bc19_Point(bc19.Util.myp);
                                    if (value >= mx) {
                                        mx = value;
                                        mxx = pi;
                                    }
                                ...
                                if (pi.karbonite && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) {
                                    ...
                                    ;
                                    bc19.Util.mr.log("dest(t) seted (karbonite). pathsize: " + path.length);
                                    return path;
                                }
                                /* add */ (que.push(pi) > 0);
                ...
                if (mxx != null && po.dist2$bc19_Point(bc19.Util.myp) > 25) {
                    bc19.Util.dest = mxx;
        ...
        Nav.backResourceToCC = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array208 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index207 = 0; index207 < array208.length; index207++) {
                        var dir = array208[index207];
                        {
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && bc19.Pilgrim.isItSafe(pi)))) {
        ...
        /*private*/ Nav.calcEnemyCastle = function () {
            for (var index209 = 0; index209 < bc19.Util.castlei_$LI$().length; index209++) {
                var po = bc19.Util.castlei_$LI$()[index209];
                {
                    if (bc19.Util.vertical && bc19.Util.p[po.x][bc19.Util.size - po.y - 1].ocastleNotDes) {
                        bc19.Util.p[po.x][bc19.Util.size - po.y - 1].ocastle = true;
                        Nav.agoal = bc19.Util.p[po.x][bc19.Util.size - po.y - 1];
                    }
                    if (bc19.Util.horizontal && bc19.Util.p[bc19.Util.size - po.x - 1][po.y].ocastleNotDes) {
                        bc19.Util.p[bc19.Util.size - po.x - 1][po.y].ocastle = true;
                        Nav.agoal = bc19.Util.p[bc19.Util.size - po.x - 1][po.y];
                    }
                }
            }
            if (bc19.Util.myCC == null)
                bc19.Util.mr.log("bullshit?!!:D");
            if (bc19.Util.revPoint(bc19.Util.myCC).ocastle || !bc19.Prophet.madeByCastle || !bc19.Crusader.madeByCastle)
                Nav.agoal = bc19.Util.revPoint(bc19.Util.myCC);
            if (bc19.Util.vertical && bc19.Util.horizontal)
        ...
        /*private*/ Nav.sadbfs = function (goal) {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array211 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index210 = 0; index210 < array211.length; index210++) {
                        var dir = array211[index210];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0)) {
                                ...
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -pi.dist2$bc19_Point(goal);
                                if (value >= mx) {
                                    mx = value;
                                    mxx = pi;
                                }
        ...
        Nav.AStarIsBack4 = function (goal) {
            bc19.Util.mr.log("LastAStar:" + Nav.ins + " flag: " + Nav.flag);
            Nav.speed = 4;
            var po = null;
            var pi;
            ...
            var value = -1;
            var path = ([]);
            var closedSet = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
                return undefined;
            }
            else {
                var array = [];
            ...
            var openSet = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
                return undefined;
            }
            else {
                var array = [];
            ...
            openSet[bc19.Util.myp.x][bc19.Util.myp.y] = true;
            var parent = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
                return undefined;
            }
            else {
            ...
            parent[bc19.Util.myp.x][bc19.Util.myp.y] = null;
            var g = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
                return undefined;
            }
            else {
                var array = [];
            ...
            g[bc19.Util.myp.x][bc19.Util.myp.y] = 0;
            var fm = new Array(1000);
            var fq = new bc19.MPriorityQueue();
            var f = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
                return undefined;
            }
            else {
                var array = [];
            ...
            f[bc19.Util.myp.x][bc19.Util.myp.y] = value;
            hp = (function () { var __o = new bc19.pointStack(); __o.__delegate = []; return __o; })();
            /* add */ (hp.__delegate.push(bc19.Util.myp) > 0);
            fm[value] = hp;
            fq.add(value);
            var fn = 0;
            var cry = 0;
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 11;
                hp = fm[fn];
                if (hp == null || hp.__delegate.length === 0) {
                    ++ccry;
                    continue;
                }
                Nav.flag = 12;
                po = hp.__delegate.pop();
                Nav.flag = 2;
                ...
                Nav.flag = 5;
                {
                    var array213 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index212 = 0; index212 < array213.length; index212++) {
                        var dir = array213[index212];
                        {
                            ++Nav.ins;
                            pi = po.dir4To(dir);
                            if (pi == null || closedSet[pi.x][pi.y] || !pi.passable || (bc19.Util.myp === po && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] !== 0))
                                continue;
                            Nav.flag = 6;
                            gg = g[po.x][po.y] + 1;
                            ...
                            f[pi.x][pi.y] = value;
                            if (fm[value] != null)
                                (fm[value].__delegate.push(pi) > 0);
                            else {
                                hp = (function () { var __o = new bc19.pointStack(); __o.__delegate = []; return __o; })();
                                /* add */ (hp.__delegate.push(pi) > 0);
                                fm[value] = hp;
                            }
                            Nav.flag = 9;
                            fq.add(value);
        ...
        Nav.AStarIsBack4p = function (goal) {
            bc19.Util.mr.log("LastAStar:" + Nav.ins + " flag: " + Nav.flag);
            Nav.speed = 4;
            var po = null;
            var pi;
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array215 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index214 = 0; index214 < array215.length; index214++) {
                        var dir = array215[index214];
                        {
                            ++Nav.ins;
                            pi = po.dir4To(dir);
                            if (pi == null || closedSet[pi.x][pi.y] || !pi.passable || (bc19.Util.myp === po && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] !== 0))
        ...
        /*private*/ Nav.h = function (pi, goal) {
            return (((Math.abs(goal.dxTo(pi)) + Math.abs(goal.dyTo(pi)) + 1) | 0) / 2 | 0);
        };
        /*private*/ Nav.h9 = function (pi, goal) {
            var mm = Math.min(Math.abs(goal.dxTo(pi)), Math.abs(goal.dyTo(pi)));
            var mam = Math.max(Math.abs(goal.dxTo(pi)), Math.abs(goal.dyTo(pi)));
            if (mm % 2 === 0)
                return ((mm | 0) / 2 | 0) + ((mam - mm + 2) / 3 | 0);
            else
                return (((mm + 1) | 0) / 2 | 0) + ((mam - mm - 1 + 2) / 3 | 0);
        };
        Nav.defCastleWithPreacher = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array217 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index216 = 0; index216 < array217.length; index216++) {
                        var dir = array217[index216];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && pi.dist2$bc19_Point(bc19.Util.myCastle) <= 36) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -pi.dist2$bc19_Point(Nav.agoal);
                                if (value >= mx && pi.dist2$bc19_Point(bc19.Util.myCastle) > 8 && !pi.karbonite && !pi.fuel && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] === 0) {
                                    mx = value;
                                    mxx = pi;
                                }
                            }
                ...
                if (po.dist2$bc19_Point(bc19.Util.myCastle) > 36 && mxx != null) {
                    bc19.Util.dest = mxx;
                    ppo = parent[bc19.Util.dest.x][bc19.Util.dest.y];
                    /* push */ (path.push(bc19.Util.dest) > 0);
                    while ((parent[ppo.x][ppo.y] != null)) {
                    ...
                    ;
                    bc19.Util.mr.log("dest(t) def. pathsize: " + path.length + " - " + Nav.ins + " - " + bc19.Util.dest + " - " + mx);
                    bc19.Util.mr.timerLog += " time3: " + (Date.now() - bc19.Util.fTime);
                    return path;
                }
            }
            ...
            if (mxx != null) {
                ...
                ;
                bc19.Util.mr.log("dest(t) def2. pathsize: " + path.length + " - " + Nav.ins + " - " + bc19.Util.dest + " - " + mx);
                bc19.Util.mr.timerLog += " time3: " + (Date.now() - bc19.Util.fTime);
                return path;
            }
            return null;
        ...
        Nav.nextAssignRes = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array219 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index218 = 0; index218 < array219.length; index218++) {
                        var dir = array219[index218];
                        {
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && (bc19.Util.myp !== po || bc19.Direction4["_$wrappers"][dir].number() < 8)) {
                                ...
                                if (pi.karbonite && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) {
                                    ...
                                    ;
                                    bc19.Util.mr.log("castle dest(t) seted (k). pathsize: " + path.length);
                                    return path;
                                }
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                ...
                if (mxx != null && bc19.Util.myp.distxy$bc19_Point(po) > 8) {
                    bc19.Util.dest = mxx;
                    ppo = parent[bc19.Util.dest.x][bc19.Util.dest.y];
                    /* push */ (path.push(bc19.Util.dest) > 0);
                    while ((parent[ppo.x][ppo.y] != null)) {
                    ...
                    ;
                    bc19.Util.mr.log("castle dest(t) seted(f). pathsize: " + path.length + " - " + Nav.ins + " - " + bc19.Util.dest + " - " + mx);
                    bc19.Util.mr.timerLog += " time3: " + (Date.now() - bc19.Util.fTime);
                    return path;
                }
            }
        ...
        Nav.attEnemeyCastle = function () {
            ...
            return Nav.AStarIsBack4(Nav.agoal);
        };
        Nav.goForExpand1 = function () {
            var myexp = ([]);
            var mn = 1000000;
            var mnn = 1000000;
            var gg = null;
            for (var index220 = 0; index220 < bc19.Util.karbonP_$LI$().length; index220++) {
                var kp = bc19.Util.karbonP_$LI$()[index220];
                {
                    mn = 1000000;
                    for (var index221 = 0; index221 < bc19.Util.castlei_$LI$().length; index221++) {
                        var po = bc19.Util.castlei_$LI$()[index221];
                        {
                            if (kp.distxy$bc19_Point(po) < mn)
                                mn = kp.distxy$bc19_Point(po);
                        }
                    }
                    for (var index222 = 0; index222 < bc19.Util.castleo_$LI$().length; index222++) {
                        var po = bc19.Util.castleo_$LI$()[index222];
                        {
                            if (kp.distxy$bc19_Point(po) < mn)
                                mn = kp.distxy$bc19_Point(po);
                        }
                    }
                    if (kp.distxy$bc19_Point(bc19.Util.myCastle) <= mn) {
                        /* add */ (myexp.push(kp) > 0);
                        if (bc19.Util.mr.getVisibleRobotMap()[kp.y][kp.x] <= 0) {
                            if (kp.distxy$bc19_Point(bc19.Util.myp) < mnn) {
                                mnn = kp.distxy$bc19_Point(bc19.Util.myp);
                                gg = kp;
                            }
                        }
                    }
            ...
            bc19.Util.mr.log(" goal : " + gg + " - " + myexp.length);
            if (gg != null)
                return Nav.AStarIsBack4p(gg);
            return null;
        };
        Nav.expandTargeti = function () {
            var mn = 1000000;
            var mnn = 1000000;
            var value;
            var gg = null;
            for (var index223 = 0; index223 < bc19.Util.resToDep_$LI$().length; index223++) {
                var po = bc19.Util.resToDep_$LI$()[index223];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index224 = 0; index224 < bc19.Util.castlei_$LI$().length; index224++) {
                        var poo = bc19.Util.castlei_$LI$()[index224];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    }
                    for (var index225 = 0; index225 < bc19.Util.castleo_$LI$().length; index225++) {
                        var poo = bc19.Util.castleo_$LI$()[index225];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    }
                    if (po.distxy$bc19_Point(bc19.Util.myp) <= mn) {
                        var valid = true;
                        for (var index226 = 0; index226 < bc19.Castle.doneDep_$LI$().length; index226++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index226];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                                }
                            }
                        }
                        for (var index227 = 0; index227 < bc19.Castle.lookInProg_$LI$().length; index227++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index227];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index228 = 0; index228 < bc19.Util.castlei_$LI$().length; index228++) {
                            var pp = bc19.Util.castlei_$LI$()[index228];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.expandTargetXXX = function () {
            ...
            var value;
            var gg = null;
            for (var index229 = 0; index229 < bc19.Util.resToDep_$LI$().length; index229++) {
                var po = bc19.Util.resToDep_$LI$()[index229];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index230 = 0; index230 < bc19.Util.castlei_$LI$().length; index230++) {
                        var poo = bc19.Util.castlei_$LI$()[index230];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    }
                    for (var index231 = 0; index231 < bc19.Util.castleo_$LI$().length; index231++) {
                        var poo = bc19.Util.castleo_$LI$()[index231];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    ...
                    if (po.distxy$bc19_Point(bc19.Util.myp) <= mn) {
                        var valid = true;
                        for (var index232 = 0; index232 < bc19.Castle.doneDep_$LI$().length; index232++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index232];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index233 = 0; index233 < bc19.Castle.lookInProg_$LI$().length; index233++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index233];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index234 = 0; index234 < bc19.Util.castlei_$LI$().length; index234++) {
                            var pp = bc19.Util.castlei_$LI$()[index234];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.nextAssignDefPre = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array236 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index235 = 0; index235 < array236.length; index235++) {
                        var dir = array236[index235];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && pi.dist2$bc19_Point(bc19.Util.myp) <= 36 && (bc19.Util.myp !== po || bc19.Direction4["_$wrappers"][dir].number() < 8)) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -pi.dist2$bc19_Point(Nav.agoal);
                                if (value >= mx && pi.dist2$bc19_Point(bc19.Util.myp) > 8 && !pi.karbonite && !pi.fuel) {
                                    mx = value;
                                    mxx = pi;
                                }
                            }
                ...
                if (po.dist2$bc19_Point(bc19.Util.myp) > 36 && mxx != null) {
                    bc19.Util.dest = mxx;
                    ppo = parent[bc19.Util.dest.x][bc19.Util.dest.y];
                    /* push */ (path.push(bc19.Util.dest) > 0);
                    while ((parent[ppo.x][ppo.y] != null)) {
        ...
        Nav.defWithProphet = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array238 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index237 = 0; index237 < array238.length; index237++) {
                        var dir = array238[index237];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0)) {
                                ...
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                if ((pi.x + pi.y) % 2 === 0 && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && !pi.karbonite && !pi.fuel && pi.dist2$bc19_Point(bc19.Util.myp) > 2) {
                                    bc19.Util.dest = pi;
                                    ppo = bc19.Util.dest;
                                    while ((parent[ppo.x][ppo.y] != null)) {
                                        /* push */ (path.push(ppo) > 0);
                                    ...
                                    ;
                                    bc19.Util.mr.log("dest prophet. pathsize: " + path.length + " - " + Nav.ins + " - " + bc19.Util.dest + " - " + mx);
                                    bc19.Util.mr.timerLog += " time3: " + (Date.now() - bc19.Util.fTime);
                                    return path;
                                }
                            }
        ...
        Nav.defWithProphet2 = function () {
            ...
            parent[bc19.Util.myp.x][bc19.Util.myp.y] = null;
            Nav.ins = 0;
            bc19.Util.mr.log("OO: " + bc19.Util.top + " - " + bc19.Util.down + " - " + bc19.Util.left + " - " + bc19.Util.right + " - " + bc19.Util.myCC);
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array240 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index239 = 0; index239 < array240.length; index239++) {
                        var dir = array240[index239];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 || (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) && pi.dist2$bc19_Point(bc19.Util.myCC) <= 36) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -bc19.Util.myCC.dist2$bc19_Point(pi) * 100;
                                if (bc19.Util.top)
                                    value += pi.y;
                                if (bc19.Util.down)
                                    value += -pi.y;
                                ...
                                if (bc19.Util.right)
                                    value += -pi.x;
                                if (value >= mx)
                                    if ((pi.x + pi.y) % 2 === (bc19.Util.myCC.x + bc19.Util.myCC.y) % 2 && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && !pi.karbonite && !pi.fuel && pi.dist2$bc19_Point(bc19.Util.myCC) > 2 && ((bc19.Util.top && pi.y >= bc19.Util.myCC.y) || (bc19.Util.down && pi.y <= bc19.Util.myCC.y) || (bc19.Util.left && pi.x >= bc19.Util.myCC.x) || (bc19.Util.right && pi.x <= bc19.Util.myCC.x))) {
                                        mx = value;
                                        mxx = pi;
                                    }
                            }
            ...
            if (mxx != null) {
                ...
                ;
                bc19.Util.mr.log("dest prophet2. pathsize: " + path.length + " - " + Nav.ins + " - " + bc19.Util.dest + " - " + mx);
                bc19.Util.mr.timerLog += " time3: " + (Date.now() - bc19.Util.fTime);
                return path;
            }
            return null;
        };
        Nav.nextAssignDefPro = function () {
            var path = ([]);
            var que = ([]);
            var parent = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
                return undefined;
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array242 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index241 = 0; index241 < array242.length; index241++) {
                        var dir = array242[index241];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Direction4["_$wrappers"][dir].number() < 8) && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 || (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) && pi.dist2$bc19_Point(bc19.Util.myCC) <= 36) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -bc19.Util.myCC.dist2$bc19_Point(pi) * 100;
            ...
            if (mxx != null) {
                ...
                ;
                bc19.Util.mr.log("assign dest prophet2. pathsize: " + path.length + " - " + Nav.ins + " - " + bc19.Util.dest + " - " + mx);
                bc19.Util.mr.timerLog += " time3: " + (Date.now() - bc19.Util.fTime);
                return path;
            }
            return null;
        };
        Nav.nextAssignDefBackPro = function () {
            var path = ([]);
            var que = ([]);
            var parent = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
                return undefined;
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array244 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index243 = 0; index243 < array244.length; index243++) {
                        var dir = array244[index243];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Direction4["_$wrappers"][dir].number() < 8) && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 || (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) && pi.dist2$bc19_Point(bc19.Util.myCC) <= 36) {
        ...
        Nav.nextAssignDefBackProX = function () {
            var path = ([]);
            var que = ([]);
            var parent = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
                return undefined;
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array246 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index245 = 0; index245 < array246.length; index245++) {
                        var dir = array246[index245];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Direction4["_$wrappers"][dir].number() < 8) && (bc19.Util.myp !== po || (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && bc19.Prophet.isItSafeX(pi))) && (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 || (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) && pi.dist2$bc19_Point(bc19.Util.myCC) <= 36) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -bc19.Util.myCC.dist2$bc19_Point(pi) * 100;
        ...
        Nav.defWithProphet2back = function () {
            bc19.Util.mr.timerLog += " time2: " + (Date.now() - bc19.Util.fTime);
            var path = ([]);
            var que = ([]);
            var parent = (function (dims) { var allocate = function (dims) { if (dims.length == 0) {
            ...
            parent[bc19.Util.myp.x][bc19.Util.myp.y] = null;
            Nav.ins = 0;
            bc19.Util.mr.log("OO: " + bc19.Util.top + " - " + bc19.Util.down + " - " + bc19.Util.left + " - " + bc19.Util.right);
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array248 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index247 = 0; index247 < array248.length; index247++) {
                        var dir = array248[index247];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 || (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) && pi.dist2$bc19_Point(bc19.Util.myCC) <= 36) {
        ...
        /*private*/ Nav.AStarIsBack9h = function (goal) {
            bc19.Util.mr.log("LastAStar:" + Nav.ins + " flag: " + Nav.flag);
            Nav.speed = 4;
            var po = null;
            var pi;
            ...
            value = Nav.h9(bc19.Util.myp, goal);
            f[bc19.Util.myp.x][bc19.Util.myp.y] = value;
            hp = (function () { var __o = new bc19.pointStack(); __o.__delegate = []; return __o; })();
            /* add */ (hp.__delegate.push(bc19.Util.myp) > 0);
            fm[value] = hp;
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array250 = function () { var result = []; for (var val in bc19.Direction9) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index249 = 0; index249 < array250.length; index249++) {
                        var dir = array250[index249];
                        {
                            ++Nav.ins;
                            pi = po.dir9To(dir);
                            if (pi == null || closedSet[pi.x][pi.y] || !pi.passable || (bc19.Util.myp === po && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] !== 0))
        ...
        Nav.harasCru = function () {
            var etc = Nav.expandTargetCCC();
            if (etc == null) {
                bc19.Util.mr.log("no goal A* :(");
                return null;
            }
            return Nav.AStarIsBack9h(bc19.Util.revPoint(etc));
        };
        Nav.followCru = function (followTarget) {
            var sp = Nav.AStarIsBack9h(followTarget);
            if (sp != null && sp.length !== 0)
                return (function (s) { return s[s.length - 1]; })(sp);
            return null;
        };
        Nav.expandTargetCCC = function () {
            var mn = 1000000;
            var mnn = 1000000;
            var bb = -10000;
            var be = null;
            var value;
            var gg = null;
            bc19.Util.mr.log("QWER : " + bc19.Util.resToDep_$LI$().length + " - " + bc19.Util.castlei_$LI$().length + " - " + bc19.Util.castleo_$LI$().length);
            for (var index251 = 0; index251 < bc19.Util.resToDep_$LI$().length; index251++) {
                var po = bc19.Util.resToDep_$LI$()[index251];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index252 = 0; index252 < bc19.Util.castlei_$LI$().length; index252++) {
                        var poo = bc19.Util.castlei_$LI$()[index252];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    }
                    for (var index253 = 0; index253 < bc19.Util.castleo_$LI$().length; index253++) {
                        var poo = bc19.Util.castleo_$LI$()[index253];
                        {
                            if (po.distxy$bc19_Point(poo) < mn)
                                mn = po.distxy$bc19_Point(poo);
                        }
                    }
                    if (po.distxy$bc19_Point(bc19.Util.myCC) <= mn) {
                        var valid = true;
                        for (var index254 = 0; index254 < bc19.Castle.doneDep_$LI$().length; index254++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index254];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index255 = 0; index255 < bc19.Castle.lookInProg_$LI$().length; index255++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index255];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index256 = 0; index256 < bc19.Util.castlei_$LI$().length; index256++) {
                            var pp = bc19.Util.castlei_$LI$()[index256];
                            {
                                if (pp.distxy$bc19_Point(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.defWithCru = function () {
            var path = ([]);
            var value = -1;
            var mx = -100000;
            var mxx = null;
            var pi;
            for (var i = bc19.Util.myCC.x - 10; i < bc19.Util.myCC.x + 10; ++i)
                for (var j = bc19.Util.myCC.y - 10; j < bc19.Util.myCC.y + 10; ++j) {
                    if (!bc19.Util.checkOnMap$int$int(i, j))
                        continue;
                    pi = bc19.Util.p[i][j];
                    value = -bc19.Util.myCC.dist2$bc19_Point(pi) * 100;
                    if (value >= mx)
                        if ((pi.x + pi.y) % 2 === (bc19.Util.myCC.x + bc19.Util.myCC.y) % 2 && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && !pi.karbonite && !pi.fuel && pi.dist2$bc19_Point(bc19.Util.myCC) > 2) {
                            mx = value;
                            mxx = pi;
                        }
                }
        ...
        Nav.oneStepToTarget = function () {
            var path = Nav.AStarIsBack4p(bc19.Util.kkp);
            if (path != null && path.length !== 0) {
                return path;
            }
            return null;
        };
        Nav.slowAttEnemeyCastle = function () {
            bc19.Util.mr.log("LastAStar:" + Nav.ins + " flag: " + Nav.flag);
            Nav.agoal = null;
            Nav.calcEnemyCastle();
            if (Nav.agoal == null) {
...
(function (bc19) {
    var Preacher = (function (_super) {
        ...
        Preacher.lastmyp_$LI$ = function () { if (Preacher.lastmyp == null)
            Preacher.lastmyp = ([]); return Preacher.lastmyp; };
        ;
        Preacher.turn = function (myRobot) {
            if (Preacher.mode === 2)
                Preacher.mode = Preacher.lastmode;
            bc19.Util.setupt(myRobot);
            /* add */ (Preacher.lastmyp_$LI$().push(bc19.Util.myp) > 0);
            if (bc19.Util.seenO.length !== 0 || bc19.Util.me.health !== 60) {
                Preacher.slowRush = false;
            }
            if (bc19.Util.me.turn === 1) {
                {
                    var array258 = bc19.Util.mr.getVisibleRobots();
                    for (var index257 = 0; index257 < array258.length; index257++) {
                        var r = array258[index257];
                        {
                            if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                                /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                                    s.push(e);
                            ...
                            if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()) {
                                if (bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 2) {
                                    bc19.Util.myCC = bc19.Util.p[r.x][r.y];
                                }
                            }
            ...
            if (Preacher.attackTarget != null) {
                ...
                if (Preacher.mode === 2) {
                    bc19.Util.subPath = bc19.Nav.oneStepToTarget();
                    if (bc19.Util.subPath != null && bc19.Util.subPath.length !== 0) {
                        var po = (function (s) { return s[s.length - 1]; })(bc19.Util.subPath);
                        if (Preacher.canReach(po)) {
                            /* pop */ bc19.Util.mainPath.pop();
                            Preacher.savePo = po;
                            bc19.Util.mr.log("move(z) a preacher. x: " + po.x + " y: " + po.y);
                            bc19.Util.dest = null;
                            bc19.Util.mainPath = null;
                            Preacher.kj = true;
                            return bc19.Util.mr.move(bc19.Util.myp.dxTo(po), bc19.Util.myp.dyTo(po));
                ...
                if ((bc19.Util.dest == null && Preacher.lastTry + 5 <= bc19.Util.me.turn) || (bc19.Util.me.turn > 6 && Preacher.lastmyp_$LI$()[bc19.Util.me.turn - 5].x === bc19.Util.myp.x && Preacher.lastmyp_$LI$()[bc19.Util.me.turn - 5].y === bc19.Util.myp.y && Preacher.lastTry + 5 <= bc19.Util.me.turn)) {
                    if (Preacher.mode === 0 && !Preacher.kj) {
                        bc19.Util.mainPath = bc19.Nav.defWithProphet2();
                    }
                    if (Preacher.mode !== 0) {
                        bc19.Util.mainPath = bc19.Nav.attEnemeyCastle();
                    }
                ...
                if (bc19.Util.dest != null && bc19.Util.dest !== bc19.Util.myp) {
                    var po = (function (s) { return s[s.length - 1]; })(bc19.Util.mainPath);
                    bc19.Util.mr.log("ss1 " + Preacher.slowRush + " - " + po);
                    if (Preacher.slowRush && bc19.Util.myp.dist2$bc19_Point(po) === 4) {
                        bc19.Util.mr.log("ss3");
                        var xx = bc19.Util.myp.x + (bc19.Util.myp.dxTo(po) / 2 | 0);
                        var yy = bc19.Util.myp.y + (bc19.Util.myp.dyTo(po) / 2 | 0);
                        if (Preacher.canReach(bc19.Util.p[xx][yy])) {
                            bc19.Util.mr.log("move slowRush a preacher. x: " + bc19.Util.p[xx][yy].x + " y: " + bc19.Util.p[xx][yy].y);
                            return bc19.Util.mr.move(bc19.Util.myp.dxTo(bc19.Util.p[xx][yy]), bc19.Util.myp.dyTo(bc19.Util.p[xx][yy]));
                        }
                    }
                    if (Preacher.canReach(po)) {
                        ...
                        if (bc19.Util.mainPath.length === 1) {
                            ...
                            var xx = bc19.Util.myp.x + po.dxTo(poo);
                            var yy = bc19.Util.myp.y + po.dyTo(poo);
                            if (bc19.Util.checkOnMap$int$int(xx, yy) && Preacher.canReach(bc19.Util.p[xx][yy])) {
        ...
        /*private*/ Preacher.canReach = function (po) {
            if (bc19.Util.myp.dist2$bc19_Point(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && Preacher.checkPreNear(po) && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2$bc19_Point(po))
                return true;
            return false;
        };
        ...
        /*private*/ Preacher.setAttackLand = function () {
            ...
            var poo = null;
            {
                var array260 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index259 = 0; index259 < array260.length; index259++) {
                    var dir = array260[index259];
                    {
                        po = Preacher.attackTarget.dirTo(dir);
                        if (po == null || po.dist2$bc19_Point(bc19.Util.myp) > 16)
                            continue;
                        w = 0;
                        f = 0;
                        e = 0;
                        {
                            var array262 = function () { var result = []; for (var val in bc19.Direction) {
                                if (!isNaN(val)) {
                                    result.push(parseInt(val, 10));
                                }
                            } return result; }();
                            for (var index261 = 0; index261 < array262.length; index261++) {
                                var dir2 = array262[index261];
                                {
                                    poo = po.dirTo(dir2);
                                    if (poo == null)
                                        continue;
        ...
        /*private*/ Preacher.checkFight = function () {
            ...
            var poo = null;
            {
                var array264 = bc19.Util.mr.getVisibleRobots();
                for (var index263 = 0; index263 < array264.length; index263++) {
                    var r = array264[index263];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 16) {
        ...
        /*private*/ Preacher.canAttack = function () {
            ...
            var po = null;
            {
                var array266 = bc19.Util.mr.getVisibleRobots();
                for (var index265 = 0; index265 < array266.length; index265++) {
                    var r = array266[index265];
                    {
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 16) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                value = 1;
...
(function (bc19) {
    var Church = (function (_super) {
        ...
        Church.turn = function (myRobot) {
            Church.waitingForPil = false;
            bc19.Util.setupt(myRobot);
            if (bc19.Util.me.turn === 1) {
                bc19.Util.myCC = bc19.Util.myp;
                for (var index267 = 0; index267 < bc19.Util.resP_$LI$().length; index267++) {
                    var po = bc19.Util.resP_$LI$()[index267];
                    {
                        if (bc19.Util.myp.distxy$bc19_Point(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
            ...
            bc19.Communication.turn();
            if (bc19.Util.me.turn === 1) {
                bc19.Communication.cmessage = bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() * 16 + 0 * 4 + 2;
            }
            else if (bc19.Util.me.turn > 1 && !Church.ydone) {
                if (!Church.xdone && bc19.Communication.lastcmessage !== bc19.Util.myp.x * 4 + 1)
                    bc19.Communication.cmessage = bc19.Util.myp.x * 4 + 1;
                if (bc19.Communication.lastcmessage === bc19.Util.myp.x * 4 + 1) {
                    Church.xdone = true;
                }
                if (Church.xdone && bc19.Communication.lastcmessage !== bc19.Util.myp.y * 4 + 1)
                    bc19.Communication.cmessage = bc19.Util.myp.y * 4 + 1;
                if (Church.xdone && bc19.Communication.lastcmessage === bc19.Util.myp.y * 4 + 1)
                    Church.ydone = true;
            }
            bc19.Communication.castleOut();
            Church.checkFight();
            Church.needForDef = false;
            Church.ut = Church.nextUnit();
            Church.cpu = Church.canProduceUnit();
            Church.needRes = false;
            if (Church.ut === bc19.UnitType.Preacher && Church.cpu != null && (bc19.Util.mr.karbonite < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Church.ut].number()].CONSTRUCTION_KARBONITE || bc19.Util.mr.fuel < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Church.ut].number()].CONSTRUCTION_FUEL) && Church.needForDef)
                Church.needRes = true;
            if (Church.needRes) {
                if (bc19.Util.me.turn > 1) {
                    bc19.Communication.cmessage = 3 * 4;
                ...
                else if (bc19.Util.me.turn === 1)
                    bc19.Communication.cmessage += 32;
                bc19.Communication.castleOut();
            }
            if (Church.ut != null && bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Church.ut].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Church.ut].number()].CONSTRUCTION_FUEL && Church.cpu != null) {
                Church.assign();
                if (Church.assignNode == null) {
                    bc19.Util.mr.log("Building a " + Church.ut + " . dir : " + Church.assignDir);
                    if (Church.ut === bc19.UnitType.Pilgrim)
                        bc19.Util.pil++;
                    else if (Church.ut === bc19.UnitType.Preacher)
                        bc19.Util.pre++;
                    else if (Church.ut === bc19.UnitType.Prophet)
                        bc19.Util.pro++;
                    return bc19.Util.mr.buildUnit(bc19.UnitType["_$wrappers"][Church.ut].number(), bc19.Util.dx(Church.assignDir), bc19.Util.dy(Church.assignDir));
                }
                else {
                    bc19.Util.mr.log("Building a " + Church.ut + " . point : " + Church.assignNode);
                    if (Church.ut === bc19.UnitType.Pilgrim)
                        bc19.Util.pil++;
                    else if (Church.ut === bc19.UnitType.Preacher)
                        bc19.Util.pre++;
                        ...
                        bc19.Util.pro++;
                    return bc19.Util.mr.buildUnit(bc19.UnitType["_$wrappers"][Church.ut].number(), bc19.Util.myp.dxTo(Church.assignNode), bc19.Util.myp.dyTo(Church.assignNode));
                }
            }
            return null;
        };
        /*private*/ Church.assign = function () {
            Church.assignNode = null;
            Church.assignDir = Church.cpu;
            if (Church.ut === bc19.UnitType.Pilgrim && bc19.Util.me.turn < 100) {
                bc19.Util.mainPath = bc19.Nav.nextAssignRes();
                if (bc19.Util.mainPath != null && bc19.Util.mainPath.length !== 0) {
                    Church.assignNode = bc19.Util.mainPath.pop();
                }
            }
            else if (Church.ut === bc19.UnitType.Prophet) {
                bc19.Util.mainPath = bc19.Nav.nextAssignDefPro();
        ...
        /*private*/ Church.nextUnit = function () {
            var uu = null;
            uu = Church.goForDef();
            if (uu != null)
                return uu;
            ...
            if (uu != null)
                return uu;
            uu = Church.readyForDef();
            if (uu != null)
                if (!Church.waitingForPil) {
                    return uu;
                }
                else
                    return bc19.UnitType.Pilgrim;
        ...
        /*private*/ Church.goForDef = function () {
            if (bc19.Util.seenO.length !== 0 && bc19.Util.seenIPreNear + bc19.Util.seenIProNear < bc19.Util.seenO.length) {
                if (bc19.Util.seenIPreNear <= 2 * bc19.Util.seenIProNear && (bc19.Util.me.health === 100 || bc19.Util.pro !== 0)) {
                    Church.needForDef = true;
                    return bc19.UnitType.Preacher;
                }
                else {
                    return bc19.UnitType.Prophet;
        ...
        /*private*/ Church.goForRes = function () {
            if (bc19.Util.seenIPilNear < bc19.Util.resGoalP_$LI$().length && (bc19.Util.pil < 2 || bc19.Util.mr.karbonite >= 40 && bc19.Util.mr.fuel >= 100) && bc19.Util.pil < 10 && bc19.Util.seenO.length === 0)
                return bc19.UnitType.Pilgrim;
            if (bc19.Util.seenIPilNear < bc19.Util.resGoalP_$LI$().length && (bc19.Util.me.turn > 20 && bc19.Util.mr.karbonite >= 10 && bc19.Util.mr.fuel >= 50) && bc19.Util.pil < 10 && bc19.Util.seenO.length === 0)
                Church.waitingForPil = true;
            return null;
        };
        /*private*/ Church.readyForDef = function () {
            if (bc19.Util.mr.karbonite >= 50 + 30 && bc19.Util.mr.fuel >= 200 + 50 && bc19.Util.seenIProNear < 3)
                return bc19.UnitType.Prophet;
            if (bc19.Util.pro < bc19.Util.seenO.length && bc19.Util.mr.karbonite >= 30 && bc19.Util.mr.fuel >= 50)
                return bc19.UnitType.Prophet;
            if (bc19.Util.pro < 3 && bc19.Util.mr.karbonite >= 40 && bc19.Util.mr.fuel >= 100 && bc19.Util.me.turn > 20)
                return bc19.UnitType.Prophet;
            if (Church.enAttack !== 0 && ((bc19.Util.mr.karbonite >= 25 + 30 + 50 && bc19.Util.mr.fuel >= 200 + 50 + 50) || (bc19.Util.me.turn > 20 && bc19.Util.mr.karbonite >= 25 + 30 && bc19.Util.mr.fuel >= 50 + 50) || Church.enAttackPro >= 3)) {
                if (Church.enAttackPro === 0) {
                    if (bc19.Util.seenIPre + bc19.Util.seenIPro < Church.enAttack)
                        if (bc19.Util.seenIPre <= 2 * bc19.Util.seenIPro && (bc19.Util.me.health === 200 || bc19.Util.pro !== 0)) {
                            return bc19.UnitType.Preacher;
                        }
                        else if (bc19.Util.seenIPro < 4) {
                            return bc19.UnitType.Prophet;
                        }
                }
                else {
                    if (bc19.Util.seenIPre + bc19.Util.seenIPro < Church.enAttack)
                        ...
                        else if (bc19.Util.seenIPro < Math.max(Church.enAttackPro + 3, 10)) {
                            return bc19.UnitType.Prophet;
                        }
                }
            }
        ...
        /*private*/ Church.checkFight = function () {
            var value = 0;
            var mx = 0;
            var mn = 10000;
            var po = null;
            var poo = null;
            {
                var array269 = bc19.Util.mr.getVisibleRobots();
                for (var index268 = 0; index268 < array269.length; index268++) {
                    var r = array269[index268];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 64) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                value = 1;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                                value = 2;
                        ...
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 100) {
                            if (mn > bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y])) {
                                poo = bc19.Util.p[r.x][r.y];
                                mn = bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]);
                            }
            ...
            Church.attackTarget = po;
            Church.dangerEnemy = poo;
            Church.enAttack = Math.max(Church.enAttack, /* size */ bc19.Util.seenO.length);
            Church.enAttackPro = Math.max(Church.enAttackPro, bc19.Util.seenOPre);
        };
        /*private*/ Church.build3Pre1Pil = function (dir) {
            if (bc19.Util.mr.karbonite >= 30) {
                bc19.Util.mr.log("Building a Preacher. dir : " + dir);
                return bc19.Util.mr.buildUnit(bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number(), bc19.Util.dx(dir), bc19.Util.dy(dir));
            }
        ...
        /*private*/ Church.build4Cru1Pil = function (dir) {
            if (bc19.Util.mr.karbonite >= 20) {
                bc19.Util.mr.log("Building a Crusader. dir : " + dir);
                return bc19.Util.mr.buildUnit(bc19.UnitType["_$wrappers"][bc19.UnitType.Crusader].number(), bc19.Util.dx(dir), bc19.Util.dy(dir));
            }
        ...
        /*private*/ Church.build4Pro = function (dir) {
            if (bc19.Util.mr.karbonite >= 25) {
                bc19.Util.mr.log("Building a Prophet. dir : " + dir);
                return bc19.Util.mr.buildUnit(bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number(), bc19.Util.dx(dir), bc19.Util.dy(dir));
            }
        ...
        /*private*/ Church.canProduceUnit = function () {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array271 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index270 = 0; index270 < array271.length; index270++) {
                    var dir = array271[index270];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                            return dir;
        ...
        /*private*/ Church.produceNewUnit = function (unitType) {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array273 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index272 = 0; index272 < array273.length; index272++) {
                    var dir = array273[index272];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                            bc19.Util.mr.log("Building a pilgrim. x : " + p2.x + " y : " + p2.y);
    ...
    Church.attackTarget = null;
    Church.dangerEnemy = null;
    Church.runAway = null;
    Church.assignDir = null;
    Church.ut = null;
    Church.cpu = null;
    Church.assignNode = null;
    Church.wave = 0;
...
(function (bc19) {
    var Prophet = (function (_super) {
        ...
        Prophet.lastmyp_$LI$ = function () { if (Prophet.lastmyp == null)
            Prophet.lastmyp = ([]); return Prophet.lastmyp; };
        ;
        Prophet.turn = function (myRobot) {
            bc19.Util.setupt(myRobot);
            /* add */ (Prophet.lastmyp_$LI$().push(bc19.Util.myp) > 0);
            if (bc19.Util.me.turn === 1) {
                Prophet.madeByCastle = false;
                {
                    var array275 = bc19.Util.mr.getVisibleRobots();
                    for (var index274 = 0; index274 < array275.length; index274++) {
                        var r = array275[index274];
                        if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() || r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) {
                            if (bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 2) {
                                bc19.Util.myCC = bc19.Util.p[r.x][r.y];
                                if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                    Prophet.madeByCastle = true;
                                else
                                    Prophet.madeByCastle = false;
                            }
                        }
            ...
            Prophet.checkFight();
            bc19.Communication.turn();
            bc19.Communication.signalInProphet();
            bc19.Communication.castleOut();
            if (bc19.Util.dangerEnemy == null && bc19.Util.attackTarget != null) {
                bc19.Util.mr.log("attack by a prophet. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
                Prophet.mode = 0;
                return bc19.Util.mr.attack(bc19.Util.myp.dxTo(bc19.Util.attackTarget), bc19.Util.myp.dyTo(bc19.Util.attackTarget));
            }
            else if (bc19.Util.dangerEnemy == null && bc19.Util.attackTarget == null) {
                if (!bc19.Util.mr.lastActionDone) {
                    /* push */ (bc19.Util.mainPath.push(Prophet.savePo) > 0);
                }
                if (bc19.Util.dest === bc19.Util.myp) {
                    if (Prophet.mode === 0) {
                        if (Prophet.madeByCastle) {
                        }
                        bc19.Util.mr.log("stoping here");
                        return null;
                    }
                ...
                if ((bc19.Util.dest == null && Prophet.lastTry + 5 <= bc19.Util.me.turn) || (bc19.Util.me.turn > 6 && Prophet.lastmyp_$LI$()[bc19.Util.me.turn - 5].x === bc19.Util.myp.x && Prophet.lastmyp_$LI$()[bc19.Util.me.turn - 5].y === bc19.Util.myp.y && Prophet.lastTry + 5 <= bc19.Util.me.turn)) {
                    if (Prophet.mode === 0) {
                        if (Prophet.madeByCastle) {
                            bc19.Util.mainPath = bc19.Nav.defWithProphet2back();
                            if (bc19.Util.mainPath == null || bc19.Util.mainPath.length === 0 || (function (s) { return s[s.length - 1]; })(bc19.Util.mainPath) == null)
                                bc19.Util.mainPath = bc19.Nav.defWithProphet2();
                        }
                        else {
                            bc19.Util.mainPath = bc19.Nav.defWithProphet2();
                ...
                if (bc19.Util.dest != null && bc19.Util.dest !== bc19.Util.myp) {
                    bc19.Util.mr.log("idiot6");
                    var po = (function (s) { return s[s.length - 1]; })(bc19.Util.mainPath);
                    if ((Prophet.mode === 5 || Prophet.slowRush) && bc19.Util.myp.dist2$bc19_Point(po) === 4) {
                        bc19.Util.mr.log("ss3");
                        var xx = bc19.Util.myp.x + (bc19.Util.myp.dxTo(po) / 2 | 0);
                        var yy = bc19.Util.myp.y + (bc19.Util.myp.dyTo(po) / 2 | 0);
                ...
                if (!Prophet.isItSafe(bc19.Util.myp)) {
                    Prophet.tryToGoToSafe();
                    if (Prophet.runAway != null) {
                        bc19.Util.mr.log("move(runaway2) a pilgrim. x: " + Prophet.runAway.x + " y: " + Prophet.runAway.y);
                ...
                if (Prophet.runAway != null) {
                    ...
                    bc19.Util.mr.log("attack and die by a prophet. x: " + bc19.Util.attackTarget.x + " y: " + bc19.Util.attackTarget.y);
                    return bc19.Util.mr.attack(bc19.Util.myp.dxTo(bc19.Util.attackTarget), bc19.Util.myp.dyTo(bc19.Util.attackTarget));
                }
            }
            return null;
        };
        /*private*/ Prophet.tryToGoToSafe = function () {
            Prophet.runAway = null;
            {
                var array277 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index276 = 0; index276 < array277.length; index276++) {
                    var dir = array277[index276];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && Prophet.canReach(po)) {
                            Prophet.runAway = po;
                            break;
                        }
                    }
            ...
            if (Prophet.runAway == null) {
                var array279 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index278 = 0; index278 < array279.length; index278++) {
                    var dir = array279[index278];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && Prophet.canHalfReach(po)) {
                            Prophet.runAway = po;
                            break;
                        }
                    }
        ...
        /*private*/ Prophet.canReachN = function (po) {
            if (bc19.Util.myp.dist2$bc19_Point(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2$bc19_Point(po))
                return true;
            return false;
        };
        /*private*/ Prophet.canReach = function (po) {
            if (bc19.Util.myp.dist2$bc19_Point(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2$bc19_Point(po) && Prophet.isItSafe(po))
                return true;
            return false;
        };
        /*private*/ Prophet.canHalfReach = function (po) {
            if (bc19.Util.myp.dist2$bc19_Point(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2$bc19_Point(po) && Prophet.isItHalfSafe(po))
                return true;
            return false;
        };
        Prophet.isItSafe = function (po) {
            for (var index280 = 0; index280 < bc19.Util.seenO.length; index280++) {
                var ppo = bc19.Util.seenO[index280];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 26)
            ...
            if (bc19.Util.dest != null && bc19.Util.dest.ocastle && po.dist2$bc19_Point(bc19.Util.dest) <= 64)
                return false;
            return true;
        };
        Prophet.isItSafeX = function (po) {
            for (var index281 = 0; index281 < bc19.Util.seenO.length; index281++) {
                var ppo = bc19.Util.seenO[index281];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 26)
        ...
        /*private*/ Prophet.isItHalfSafe = function (po) {
            for (var index282 = 0; index282 < bc19.Util.seenO.length; index282++) {
                var ppo = bc19.Util.seenO[index282];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2$bc19_Point(ppo) <= 16)
        ...
        /*private*/ Prophet.justRunAway = function () {
            Prophet.runAway = null;
            {
                var array284 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index283 = 0; index283 < array284.length; index283++) {
                    var dir = array284[index283];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2$bc19_Point(bc19.Util.dangerEnemy) > 16) {
                            Prophet.runAway = po;
                            break;
                        }
                    }
        ...
        /*private*/ Prophet.checkFight = function () {
            ...
            var poo = null;
            {
                var array286 = bc19.Util.mr.getVisibleRobots();
                for (var index285 = 0; index285 < array286.length; index285++) {
                    var r = array286[index285];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) <= 64 && bc19.Util.myp.dist2$bc19_Point(bc19.Util.p[r.x][r.y]) >= 16) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                value = 1;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                                value = 2;
        ...
        MyRobot.prototype.turn = function () {
            ...
            switch ((function () { var result = []; for (var val in bc19.UnitType) {
                ...
                case bc19.UnitType.Church:
                    this.action = bc19.Church.turn(this);
                    break;
...
bc19.Prophet.lastmyp_$LI$();
bc19.Preacher.lastmyp_$LI$();
bc19.Castle.doneDep_$LI$();
bc19.Castle.lookInProg_$LI$();
bc19.Crusader.lastmyp_$LI$();
bc19.MPriorityQueue.MAX_ARRAY_SIZE_$LI$();
bc19.Util.knownRListChu_$LI$();
bc19.Util.knownRList_$LI$();
bc19.Util.lastKnownR_$LI$();
bc19.Util.yr_$LI$();
bc19.Util.xr_$LI$();
bc19.Util.typeKnownR_$LI$();
bc19.Util.allKnownR_$LI$();
bc19.Util.potDep_$LI$();
bc19.Util.resToDep_$LI$();
