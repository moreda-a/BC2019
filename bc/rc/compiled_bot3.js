    ...
    var HashMap = (function () {
        ...
        HashMap.prototype.getFirst = function () {
            ...
            while ((meo != null && meo.isRemoved())) {
                meo = (function (a) { return a.length == 0 ? null : a.shift(); })(this.list);
...
(function (bc19) {
    var Nav = (function (_super) {
        ...
        Nav.AStar9 = function (goal) {
            ...
            var value = -1;
            var path = ([]);
            var closedSet = new bc19.MHashSet();
            var openSet = new bc19.MHashSet();
        ...
        Nav.AStar4 = function (goal) {
            ...
            while ((!openSet.isEmpty())) {
                bc19.Util.mr.log("SIZE: " + openSet.size() + " - " + closedSet.size() + " - " + (function (m) { if (m.entries == null)
                    m.entries = []; return m.entries.length; })(parent) + " - " + (function (m) { if (m.entries == null)
                    m.entries = []; return m.entries.length; })(g) + " -fm- " + (function (m) { if (m.entries == null)
                    m.entries = []; return m.entries.length; })(fm) + " - " + fq.size() + " - " + (function (m) { if (m.entries == null)
                    m.entries = []; return m.entries.length; })(f));
                if (fq.size() === 0) {
                ...
                bc19.Util.mr.log("hello : " + (function (a) { return a ? '[' + a.join(', ') + ']' : 'null'; })(hp.getList()));
                po = hp.getFirst();
                Nav.flag = 2;
                if (!openSet.contains(po)) {
                    ++cry;
                        ...
                        var dir = array145[index144];
                        {
                            ...
                            if ((function (m, k) { if (m.entries == null)
                                ...
                                if ((function (m, k) { if (m.entries == null)
                                    ...
                                    if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                        return m.entries[i].value;
                                    } return null; })(f, pi)) == null) {
                                    bc19.Util.mr.log("tt :" + (function (m, k) { if (m.entries == null)
                                        m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                        if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                            return m.entries[i].value;
                                        } return null; })(f, pi) + " - " + (function (m) { if (m.entries == null)
                                        m.entries = []; return m.entries.length; })(fm) + " - " + (function (m) { if (m.entries == null)
                                        m.entries = []; return m.entries.length; })(f) + " - " + fq.size());
                                }
