...
(function (bc19) {
    var Util = (function () {
        ...
        Util.init = function (myRobot) {
            ...
            for (var i = 0; i < Util.size; ++i) {
                for (var j = 0; j < Util.size; ++j) {
                    ...
                    if (Util.vertical && Util.mr.map[j][i] !== Util.mr.map[Util.size - j - 1][i]) {
                        Util.vertical = false;
                    }
                    if (Util.horizontal && Util.mr.map[j][i] !== Util.mr.map[j][Util.size - i - 1]) {
        ...
        Util.calcDep = function () {
            ...
            var ppo = null;
            var first = ([]);
            for (var index123 = 0; index123 < Util.resP_$LI$().length; index123++) {
                var po = Util.resP_$LI$()[index123];
                {
                    {
                        var array125 = function () { var result = []; for (var val in bc19.Direction) {
                            if (!isNaN(val)) {
                                result.push(parseInt(val, 10));
                            }
                        } return result; }();
                        for (var index124 = 0; index124 < array125.length; index124++) {
                            var dir = array125[index124];
                            {
                                pi = po.dirTo(dir);
            ...
            for (var index126 = 0; index126 < Util.resP_$LI$().length; index126++) {
                var po = Util.resP_$LI$()[index126];
                {
                    mx = -1;
                    ppo = null;
                    {
                        var array128 = function () { var result = []; for (var val in bc19.Direction9) {
                            if (!isNaN(val)) {
                                result.push(parseInt(val, 10));
                            }
                        } return result; }();
                        for (var index127 = 0; index127 < array128.length; index127++) {
                            var dir = array128[index127];
                            {
                                pi = po.dir9To(dir);
...
(function (bc19) {
    var Crusader = (function (_super) {
        ...
        /*private*/ Crusader.canAttack = function () {
            ...
            var po = null;
            {
                var array130 = bc19.Util.mr.getVisibleRobots();
                for (var index129 = 0; index129 < array130.length; index129++) {
                    var r = array130[index129];
                    {
...
(function (bc19) {
    var Pilgrim = (function (_super) {
            ...
            if (bc19.Util.me.turn === 1) {
                ...
                for (var i = 0; i < bc19.Util.size; ++i)
                    for (var j = 0; j < bc19.Util.size; ++j) {
                        if (bc19.Util.myp.distxy(bc19.Util.p[i][j]) <= 6 && (bc19.Util.p[i][j].fuel || bc19.Util.p[i][j].karbonite))
                            (bc19.Util.resGoalP_$LI$().push(bc19.Util.p[i][j]) > 0);
                    }
                ;
                ;
                if (bc19.Util.resGoalP_$LI$().length > bc19.Util.seenIPil) {
                    Pilgrim.miner = true;
                }
            }
            if (Pilgrim.ret) {
            ...
            if (Pilgrim.scouting) {
                if (bc19.Util.dangerEnemy == null && bc19.Util.attackTarget != null) {
                    if (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[bc19.Util.attackTarget.y][bc19.Util.attackTarget.x]).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                        var value = void 0;
                        var mx = 0;
                        for (var index133 = 0; index133 < bc19.Util.seenI.length; index133++) {
                            var po = bc19.Util.seenI[index133];
                            {
        ...
        /*private*/ Pilgrim.tryToGoToSafe = function () {
            ...
            {
                var array135 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
            ...
            {
                var array137 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index136 = 0; index136 < array137.length; index136++) {
                    var dir = array137[index136];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (Pilgrim.canHalfReach(po)) {
                            Pilgrim.runAway = po;
                            break;
                        }
                    }
        ...
        /*private*/ Pilgrim.justRunAway = function () {
            ...
            {
                var array145 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
        ...
        Pilgrim.isItSafe = function (po) {
            for (var index146 = 0; index146 < bc19.Util.seenO.length; index146++) {
                var ppo = bc19.Util.seenO[index146];
                {
        ...
        /*private*/ Pilgrim.isItHalfSafe = function (po) {
            for (var index147 = 0; index147 < bc19.Util.seenO.length; index147++) {
                var ppo = bc19.Util.seenO[index147];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
        ...
        /*private*/ Pilgrim.checkFight = function () {
            ...
            var pp;
            {
                var array149 = bc19.Util.mr.getVisibleRobots();
                for (var index148 = 0; index148 < array149.length; index148++) {
                    var r = array149[index148];
                    {
            ...
            for (var index150 = 0; index150 < bc19.Util.seenIR.length; index150++) {
                var r = bc19.Util.seenIR[index150];
                {
                    pp = bc19.Util.p[r.x][r.y];
        ...
        /*private*/ Pilgrim.canGive = function () {
            {
                var array152 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index151 = 0; index151 < array152.length; index151++) {
                    var dir = array152[index151];
                    {
        ...
        /*private*/ Pilgrim.canMove = function () {
            ...
            var ddir = null;
            {
                var array154 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index153 = 0; index153 < array154.length; index153++) {
                    var dir = array154[index153];
                    {
                        var p2 = bc19.Util.myp.dirTo(dir);
...
(function (bc19) {
    var Castle = (function (_super) {
        ...
        Castle.turn = function (myRobot) {
            ...
            bc19.Util.setupt(myRobot);
            if (bc19.Util.me.turn === 1) {
                for (var index155 = 0; index155 < bc19.Util.resP_$LI$().length; index155++) {
                    var po = bc19.Util.resP_$LI$()[index155];
                    {
            ...
            Castle.wave = 0;
            if (bc19.Util.pre !== 0 && bc19.Util.pre % 4 === 0 && !Castle.vwave) {
                Castle.wave = 4;
                Castle.vwave = true;
            }
            else if (bc19.Util.pre % 4 !== 0) {
                Castle.vwave = false;
            }
            bc19.Communication.turn();
        ...
        /*private*/ Castle.nextUnit = function () {
            if (bc19.Util.seenO.length !== 0 && bc19.Util.seenIPre === 0) {
                return bc19.UnitType.Preacher;
            }
            if (Castle.stopUsingRes)
                return null;
            if (bc19.Util.seenIPil < bc19.Util.resGoalP_$LI$().length && (bc19.Util.pil < 2 || bc19.Util.mr.karbonite >= 40 && bc19.Util.mr.fuel >= 100))
                return bc19.UnitType.Pilgrim;
            if (bc19.Util.me.turn >= 20) {
                if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_FUEL && (bc19.Util.pre % 4 !== 3 || bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].FUEL_PER_MOVE * 160)) {
                    return bc19.UnitType.Preacher;
                }
            }
            {
                if (bc19.Util.seenIPil >= bc19.Util.resGoalP_$LI$().length && Castle.pili < 2 && bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].CONSTRUCTION_FUEL && (Castle.lastPili === -1 || bc19.Util.me.turn > Castle.lastPili + 10)) {
                    if (bc19.Nav.expandTarget() != null && (bc19.Util.pre >= 1 || bc19.Util.mr.karbonite >= 40 && bc19.Util.mr.fuel >= 100)) {
        ...
        /*private*/ Castle.checkFight = function () {
            ...
            var po = null;
            var poo = null;
            for (var index156 = 0; index156 < bc19.Util.seenOR.length; index156++) {
                var r = bc19.Util.seenOR[index156];
                {
...
(function (bc19) {
    var Communication = (function (_super) {
        ...
        Communication.signalInPreacher = function () {
            ...
            {
                var array164 = bc19.Util.mr.getVisibleRobots();
                for (var index163 = 0; index163 < array164.length; index163++) {
                    var r = array164[index163];
                    {
        ...
        Communication.signalOutCastle = function () {
            if (Communication.maxSignalRangeExpand !== 0) {
                bc19.Castle.expTarget = bc19.Nav.expandTarget();
                if (bc19.Castle.expTarget != null)
                    Communication.smessage = bc19.Castle.expTarget.x * (Math.pow(2, 10) | 0) + bc19.Castle.expTarget.y * (Math.pow(2, 4) | 0) + 8;
                /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                    s.push(e);
                    return true;
                }
                ...
                if (Communication.maxSignalRangeM !== 0 && bc19.Castle.wave !== 0) {
                    if (Communication.maxSignalRange === 0) {
                        ...
                        if ((function (m) { if (m.entries == null)
                            ...
                            {
                                var array168 = (function (m) { var r = []; if (m.entries == null)
                                    m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                    r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                                for (var index167 = 0; index167 < array168.length; index167++) {
                                    var id = array168[index167];
                                    {
                                        Communication.smessage = (function (m, k) { if (m.entries == null)
                                            m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                            if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                    ...
                    if ((function (m) { if (m.entries == null)
                        ...
                        var t = bc19.Util.me.turn % 2;
                        {
                            var array170 = (function (m) { var r = []; if (m.entries == null)
                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                            for (var index169 = 0; index169 < array170.length; index169++) {
                                var id = array170[index169];
                                {
                                    if (t === 0) {
                                        Communication.smessage = (function (m, k) { if (m.entries == null)
                                            m.entries = []; for (var i = 0; i < m.entries.length; i++)
                        ...
                        m.entries = []; return m.entries.length; })(bc19.Util.xid_$LI$()) === 1) {
                        {
                            var array172 = (function (m) { var r = []; if (m.entries == null)
                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                            for (var index171 = 0; index171 < array172.length; index171++) {
                                var id = array172[index171];
                                {
                                    Communication.smessage = (function (m, k) { if (m.entries == null)
                                        m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                        if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
    ...
    var Nav = (function (_super) {
        ...
        Nav.destSetPilgrimToResource = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                ...
                {
                    var array176 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
        ...
        Nav.backResourceToCC = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array178 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
        ...
        /*private*/ Nav.calcEnemyCastle = function () {
            for (var index179 = 0; index179 < bc19.Util.castlei_$LI$().length; index179++) {
                var po = bc19.Util.castlei_$LI$()[index179];
                {
            ...
            {
                var array181 = bc19.Util.mr.getVisibleRobots();
                for (var index180 = 0; index180 < array181.length; index180++) {
                    var r = array181[index180];
                    {
                        if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                            if (bc19.Util.vertical && bc19.Util.p[r.x][bc19.Util.size - r.y - 1].ocastleNotDes) {
                                bc19.Util.p[r.x][bc19.Util.size - r.y - 1].ocastle = true;
                                Nav.agoal = bc19.Util.p[r.x][bc19.Util.size - r.y - 1];
                            }
                            if (bc19.Util.horizontal && bc19.Util.p[bc19.Util.size - r.x - 1][r.y].ocastleNotDes) {
        ...
        /*private*/ Nav.sadbfs = function (goal) {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array183 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index182 = 0; index182 < array183.length; index182++) {
                        var dir = array183[index182];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
        ...
        Nav.AStarIsBack4 = function (goal) {
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array185 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index184 = 0; index184 < array185.length; index184++) {
                        var dir = array185[index184];
                        {
                            ++Nav.ins;
                            pi = po.dir4To(dir);
        ...
        Nav.AStarIsBack4p = function (goal) {
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array187 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index186 = 0; index186 < array187.length; index186++) {
                        var dir = array187[index186];
                        {
                            ++Nav.ins;
                            pi = po.dir4To(dir);
                            if (pi == null || closedSet[pi.x][pi.y] || !pi.passable || (bc19.Util.myp === po && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] !== 0))
        ...
        Nav.defCastleWithPreacher = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array189 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index188 = 0; index188 < array189.length; index188++) {
                        var dir = array189[index188];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && pi.dist2(bc19.Util.myCastle) <= 16) {
                                ...
                                if (value >= mx && pi.dist2(bc19.Util.myCastle) > 8 && !pi.karbonite && !pi.fuel) {
                                    mx = value;
                                    mxx = pi;
                                }
                            }
        ...
        Nav.nextAssignRes = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array191 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index190 = 0; index190 < array191.length; index190++) {
                        var dir = array191[index190];
                        {
                            pi = po.dir4To(dir);
        ...
        Nav.goForExpand1 = function () {
            ...
            var mnn = 1000000;
            var gg = null;
            for (var index192 = 0; index192 < bc19.Util.karbonP_$LI$().length; index192++) {
                var kp = bc19.Util.karbonP_$LI$()[index192];
                {
                    mn = 1000000;
                    for (var index193 = 0; index193 < bc19.Util.castlei_$LI$().length; index193++) {
                        var po = bc19.Util.castlei_$LI$()[index193];
                        {
                            if (kp.distxy(po) < mn)
                                mn = kp.distxy(po);
                        }
                    }
                    for (var index194 = 0; index194 < bc19.Util.castleo_$LI$().length; index194++) {
                        var po = bc19.Util.castleo_$LI$()[index194];
                        {
                            if (kp.distxy(po) < mn)
                                mn = kp.distxy(po);
                        }
        ...
        Nav.expandTarget = function () {
            var mn = 1000000;
            var mnn = 1000000;
            var value;
            var gg = null;
            for (var index195 = 0; index195 < bc19.Util.resToDep_$LI$().length; index195++) {
                var po = bc19.Util.resToDep_$LI$()[index195];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index196 = 0; index196 < bc19.Util.castlei_$LI$().length; index196++) {
                        var poo = bc19.Util.castlei_$LI$()[index196];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    }
                    for (var index197 = 0; index197 < bc19.Util.castleo_$LI$().length; index197++) {
                        var poo = bc19.Util.castleo_$LI$()[index197];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    ...
                    if (po.distxy(bc19.Util.myp) <= mn) {
                        var valid = true;
                        for (var index198 = 0; index198 < bc19.Castle.doneDep_$LI$().length; index198++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index198];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index199 = 0; index199 < bc19.Castle.lookInProg_$LI$().length; index199++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index199];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index200 = 0; index200 < bc19.Util.castlei_$LI$().length; index200++) {
                            var pp = bc19.Util.castlei_$LI$()[index200];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.nextAssignDefPre = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array202 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index201 = 0; index201 < array202.length; index201++) {
                        var dir = array202[index201];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                    ...
                    for (var index205 = 0; index205 < array206.length; index205++) {
                        var dir = array206[index205];
                        {
                            ...
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0)) {
                                ...
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                if ((pi.x + pi.y) % 2 === 0 && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && !pi.karbonite && !pi.fuel && pi.dist2(bc19.Util.myCC) > 2 && ((bc19.Util.top && pi.y >= bc19.Util.myCC.y) || (bc19.Util.down && pi.y <= bc19.Util.myCC.y) || (bc19.Util.left && pi.x >= bc19.Util.myCC.x) || (bc19.Util.right && pi.x <= bc19.Util.myCC.x))) {
                                    bc19.Util.dest = pi;
                                    ppo = bc19.Util.dest;
                                    while ((parent[ppo.x][ppo.y] != null)) {
                                        /* push */ (path.push(ppo) > 0);
...
(function (bc19) {
    var Preacher = (function (_super) {
        ...
        Preacher.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array208 = bc19.Util.mr.getVisibleRobots();
                    for (var index207 = 0; index207 < array208.length; index207++) {
                        var r = array208[index207];
                        if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                            /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                                s.push(e);
                                return true;
        ...
        /*private*/ Preacher.setAttackLand = function () {
            ...
            var poo = null;
            {
                var array210 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index209 = 0; index209 < array210.length; index209++) {
                    var dir = array210[index209];
                    {
                        ...
                        e = 0;
                        {
                            var array212 = function () { var result = []; for (var val in bc19.Direction) {
                                if (!isNaN(val)) {
                                    result.push(parseInt(val, 10));
                                }
                            } return result; }();
                            for (var index211 = 0; index211 < array212.length; index211++) {
                                var dir2 = array212[index211];
                                {
                                    poo = po.dirTo(dir2);
                                    if (poo == null)
                                        continue;
        ...
        /*private*/ Preacher.checkFight = function () {
            ...
            var poo = null;
            {
                var array214 = bc19.Util.mr.getVisibleRobots();
                for (var index213 = 0; index213 < array214.length; index213++) {
                    var r = array214[index213];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 16) {
        ...
        /*private*/ Preacher.canAttack = function () {
            ...
            var po = null;
            {
                var array216 = bc19.Util.mr.getVisibleRobots();
                for (var index215 = 0; index215 < array216.length; index215++) {
                    var r = array216[index215];
                    {
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 16) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                value = 1;
...
(function (bc19) {
    var Church = (function (_super) {
        ...
        /*private*/ Church.nextUnit = function () {
            if (Church.seenPil < bc19.Util.resGoalP_$LI$().length && (bc19.Util.pil < 2 || bc19.Util.mr.karbonite >= 40 && bc19.Util.mr.fuel >= 100))
                return bc19.UnitType.Pilgrim;
            if (bc19.Util.mr.karbonite >= 50 + 25 && bc19.Util.mr.fuel >= 200 + 50 && bc19.Util.pro < 25)
        ...
        /*private*/ Church.checkFight = function () {
            ...
            var poo = null;
            {
                var array218 = bc19.Util.mr.getVisibleRobots();
                for (var index217 = 0; index217 < array218.length; index217++) {
                    var r = array218[index217];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        ...
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && bc19.Util.p[r.x][r.y] !== bc19.Util.myp) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                                Church.seenPil++;
                            /* add */ (Church.seenFriend.push(bc19.Util.p[r.x][r.y]) > 0);
                        }
                    }
                }
            }
        ...
        /*private*/ Church.canProduceUnit = function () {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array220 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
        ...
        /*private*/ Church.produceNewUnit = function (unitType) {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array222 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
...
(function (bc19) {
    var Prophet = (function (_super) {
        ...
        Prophet.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array224 = bc19.Util.mr.getVisibleRobots();
                    for (var index223 = 0; index223 < array224.length; index223++) {
                        var r = array224[index223];
        ...
        /*private*/ Prophet.justRunAway = function () {
            ...
            {
                var array226 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index225 = 0; index225 < array226.length; index225++) {
                    var dir = array226[index225];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
        ...
        /*private*/ Prophet.checkFight = function () {
            ...
            var poo = null;
            {
                var array228 = bc19.Util.mr.getVisibleRobots();
                for (var index227 = 0; index227 < array228.length; index227++) {
                    var r = array228[index227];
                    {
