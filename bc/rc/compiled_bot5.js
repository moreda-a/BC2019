...
(function (bc19) {
    ...
    var MapEntryIM = (function () {
        function MapEntryIM(key2, value2, next2) {
            var _this = this;
            if (((typeof key2 === 'number') || key2 === null) && ((value2 != null && value2 instanceof bc19.MHashSet) || value2 === null) && ((next2 != null && next2 instanceof bc19.MapEntryIM) || next2 === null)) {
            ...
            else if (((typeof key2 === 'number') || key2 === null) && ((value2 != null && value2 instanceof bc19.MHashSet) || value2 === null) && next2 === undefined) {
                var __args = Array.prototype.slice.call(arguments);
                var k_1 = __args[0];
                var v_1 = __args[1];
                this.removed = false;
...
(function (bc19) {
    ...
    var HashMapIM = (function () {
         ...
         *
         * @param {number} key
         * @param {bc19.MHashSet} value
         * @return {bc19.MHashSet}
         */
