...
(function (bc19) {
    var Pilgrim = (function (_super) {
                ...
                if (Pilgrim.dangerEnemy != null) {
                    ...
                    if ((bc19.Util.dest == null || Pilgrim.recalc % 4 === 3) && Pilgrim.lastTry + 5 <= bc19.Util.me.turn) {
                        ...
                        if (bc19.Util.me.karbonite === 20 || bc19.Util.me.fuel === 100)
                            ...
                            if (bc19.Util.mainPath.length > 5 && bc19.Util.mr.karbonite >= 50 && bc19.Util.mr.fuel >= 200) {
                                Pilgrim.rBuildChurch();
                                if (Pilgrim.buildChurchPoint != null) {
                                    bc19.Util.mainPath = null;
                                    bc19.Util.dest = null;
                                    return bc19.Util.mr.buildUnit(bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number(), bc19.Util.myp.dxTo(Pilgrim.buildChurchPoint), bc19.Util.myp.dxTo(Pilgrim.buildChurchPoint));
                                }
                            }
                        }
                    }
        ...
        /*private*/ Pilgrim.justRunAway = function () {
            ...
            if (bc19.Util.mr.getRobot(Pilgrim.dangerEnemyId).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                {
                    ...
                    for (var index128 = 0; index128 < array129.length; index128++) {
                        var dir = array129[index128];
                        {
                            ...
                            if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2(Pilgrim.dangerEnemy) > 26) {
                                Pilgrim.runAway = po;
                                break;
                            }
                        }
            ...
            {
                var array131 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index130 = 0; index130 < array131.length; index130++) {
                    var dir = array131[index130];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
            ...
            {
                var array133 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
        ...
        /*private*/ Pilgrim.canReach = function (po) {
            if (bc19.Util.myp.dist2(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po) && Pilgrim.safeToGo(po))
                return true;
            return false;
        };
        /*private*/ Pilgrim.safeToGo = function (po) {
            if (Pilgrim.attackTarget == null || (po.dist2(Pilgrim.attackTarget) > bc19.Util.mr.SPECS.UNITS[Pilgrim.attackTargetR.unit].VISION_RADIUS && (Pilgrim.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number() || Pilgrim.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Crusader].number())) || (po.dist2(Pilgrim.attackTarget) > 26 && Pilgrim.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()))
                return true;
            return false;
        };
        ...
        /*private*/ Pilgrim.checkFight = function () {
            ...
            var poo = null;
            {
                var array135 = bc19.Util.mr.getVisibleRobots();
                for (var index134 = 0; index134 < array135.length; index134++) {
                    var r = array135[index134];
                    {
                        ...
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 100) {
                            ...
                            if (value > mx) {
                                po = bc19.Util.p[r.x][r.y];
                                mx = value;
                                Pilgrim.attackTargetR = r;
                            }
                        }
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && ((bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= bc19.Util.mr.SPECS.UNITS[r.unit].VISION_RADIUS && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number() && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) || (bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 26 && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()))) {
        ...
        /*private*/ Pilgrim.canGive = function () {
            {
                var array137 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
...
(function (bc19) {
    var Castle = (function (_super) {
        ...
        /*private*/ Castle.nextUnit = function () {
            ...
            if (Castle.seenPil < bc19.Util.resGoalP_$LI$().length)
                return bc19.UnitType.Pilgrim;
            if (bc19.Util.me.turn >= 20) {
                if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_FUEL && (Castle.pre % 4 !== 3 || bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].FUEL_PER_MOVE * 160))
                    return bc19.UnitType.Preacher;
            }
            if (bc19.Util.me.turn >= 50) {
                if (Castle.pil < ((bc19.Util.karbonP_$LI$().length + bc19.Util.fuelP_$LI$().length) / (2 * (function (m) { if (m.entries == null)
                    m.entries = []; return m.entries.length; })(bc19.Util.xid_$LI$()) + 2) | 0))
                    return bc19.UnitType.Pilgrim;
            }
            return null;
        };
        /*private*/ Castle.checkFight = function () {
            ...
            var poo = null;
            {
                var array141 = bc19.Util.mr.getVisibleRobots();
                for (var index140 = 0; index140 < array141.length; index140++) {
                    var r = array141[index140];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
        ...
        /*private*/ Castle.canProduceUnit = function () {
            ...
            {
                var array143 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
...
(function (bc19) {
    var Communication = (function (_super) {
        ...
        Communication.castleInCastle = function () {
            {
                var array147 = bc19.Util.mr.getVisibleRobots();
                for (var index146 = 0; index146 < array147.length; index146++) {
                    var r = array147[index146];
                    {
        ...
        Communication.signalOutCastle = function () {
            if (Communication.maxSignalRangeM !== 0 && bc19.Castle.wave !== 0) {
                ...
                if ((function (m) { if (m.entries == null)
                    ...
                    m.entries = []; return m.entries.length; })(bc19.Util.xid_$LI$()) === 1) {
                    {
                        var array157 = (function (m) { var r = []; if (m.entries == null)
                            m.entries = []; for (var i = 0; i < m.entries.length; i++)
                            r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                        for (var index156 = 0; index156 < array157.length; index156++) {
                            var id = array157[index156];
                            {
                                Communication.smessage = (function (m, k) { if (m.entries == null)
                                    m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                    if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
        ...
        Communication.signalInPilgrim = function () {
            ...
            bc19.Preacher.stopCommand = false;
            {
                var array159 = bc19.Util.mr.getVisibleRobots();
                for (var index158 = 0; index158 < array159.length; index158++) {
                    var r = array159[index158];
                    {
                        if (!bc19.Util.mr.isRadioing(r) || (bc19.Util.mr.isVisible(r) && bc19.Util.mr.getRobot(r.id).team !== bc19.Team["_$wrappers"][bc19.Util.teami].number()))
                            continue;
    ...
    var Nav = (function (_super) {
        ...
        Nav.backResourceToCC = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array163 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index162 = 0; index162 < array163.length; index162++) {
                        var dir = array163[index162];
                        {
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0)) {
        ...
        /*private*/ Nav.calcEnemyCastle = function () {
            ...
            ;
            ;
            for (var index164 = 0; index164 < bc19.Util.castlei_$LI$().length; index164++) {
                var po = bc19.Util.castlei_$LI$()[index164];
                {
                    if (vertical && bc19.Util.p[po.x][bc19.Util.size - po.y - 1].ocastleDes) {
                        bc19.Util.p[po.x][bc19.Util.size - po.y - 1].ocastle = true;
                        Nav.agoal = bc19.Util.p[po.x][bc19.Util.size - po.y - 1];
                    }
                    if (horizontal && bc19.Util.p[bc19.Util.size - po.x - 1][po.y].ocastleDes) {
            ...
            {
                var array166 = bc19.Util.mr.getVisibleRobots();
                for (var index165 = 0; index165 < array166.length; index165++) {
                    var r = array166[index165];
                    {
                        if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                            if (vertical && bc19.Util.p[r.x][bc19.Util.size - r.y - 1].ocastleDes) {
                                bc19.Util.p[r.x][bc19.Util.size - r.y - 1].ocastle = true;
                                Nav.agoal = bc19.Util.p[r.x][bc19.Util.size - r.y - 1];
                            }
                            if (horizontal && bc19.Util.p[bc19.Util.size - r.x - 1][r.y].ocastleDes) {
        ...
        Nav.defCastleWithPreacher = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array172 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index171 = 0; index171 < array172.length; index171++) {
                        var dir = array172[index171];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && !pi.karbonite && !pi.fuel && pi.dist2(bc19.Util.myCastle) <= 16) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
        ...
        Nav.nextAssignRes = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array174 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
...
(function (bc19) {
    var Preacher = (function (_super) {
        ...
        Preacher.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array176 = bc19.Util.mr.getVisibleRobots();
                    for (var index175 = 0; index175 < array176.length; index175++) {
                        var r = array176[index175];
                        if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                            /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                                s.push(e);
                                return true;
            ...
            if (Preacher.attackTarget != null) {
                ...
                if (bc19.Util.dest === bc19.Util.myp) {
                    if (Preacher.mode === 0)
                        return null;
                    bc19.Util.dest.ocastle = false;
                    bc19.Util.dest.ocastleDes = false;
                    bc19.Util.dest = null;
                }
...
(function (bc19) {
    var Church = (function (_super) {
        ...
        /*private*/ Church.nextUnit = function () {
            if (Church.seenPil < bc19.Util.resGoalP_$LI$().length)
                return bc19.UnitType.Pilgrim;
            return null;
        };
        ...
        /*private*/ Church.canProduceUnit = function () {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array188 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
        ...
        /*private*/ Church.produceNewUnit = function (unitType) {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array190 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
...
(function (bc19) {
    var Prophet = (function (_super) {
        ...
        /*private*/ Prophet.justRunAway = function () {
            ...
            {
                var array192 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index191 = 0; index191 < array192.length; index191++) {
                    var dir = array192[index191];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
        ...
        /*private*/ Prophet.checkFight = function () {
            ...
            var poo = null;
            {
                var array194 = bc19.Util.mr.getVisibleRobots();
                for (var index193 = 0; index193 < array194.length; index193++) {
                    var r = array194[index193];
                    {
