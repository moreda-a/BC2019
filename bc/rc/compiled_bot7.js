    ...
    var Castle = (function (_super) {
        ...
        /*private*/ Castle.nextUnit = function () {
            ...
            if (bc19.Util.me.turn >= 20) {
                if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_FUEL)
                    return bc19.UnitType.Preacher;
            }
            return null;
        };
