...
(function (bc19) {
    var Crusader = (function (_super) {
            ...
            var pgo = null;
            {
                ...
                for (var index135 = 0; index135 < array136.length; index135++) {
                    var r = array136[index135];
                    {
                        ...
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) >= 16 && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 49) {
                            value = 0;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                                value = 2;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        ...
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 16) {
                            if (mn > bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
        ...
        /*private*/ Crusader.canReach = function (po) {
            if (bc19.Util.myp.dist2(po) <= 9 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po) && Crusader.isItSafe(po))
                return true;
            return false;
        };
        /*private*/ Crusader.canHalfReach = function (po) {
            if (bc19.Util.myp.dist2(po) <= 9 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po) && Crusader.isItHalfSafe(po))
                return true;
            return false;
        };
            ...
            for (var index141 = 0; index141 < bc19.Util.seenO.length; index141++) {
                var ppo = bc19.Util.seenO[index141];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2(ppo) <= 26)
                        return false;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && po.dist2(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                }
            }
            return true;
        ...
        /*private*/ Crusader.isItHalfSafe = function (po) {
            for (var index142 = 0; index142 < bc19.Util.seenO.length; index142++) {
                var ppo = bc19.Util.seenO[index142];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2(ppo) <= 16)
                        return false;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && po.dist2(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                }
...
(function (bc19) {
    var Pilgrim = (function (_super) {
            ...
            if (Pilgrim.scouting) {
                if (bc19.Util.dangerEnemy == null && bc19.Util.attackTarget != null) {
                    if (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[bc19.Util.attackTarget.y][bc19.Util.attackTarget.x]).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                        ...
                        for (var index147 = 0; index147 < bc19.Util.seenI.length; index147++) {
                            ...
                            {
                                if (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[bc19.Util.attackTarget.y][bc19.Util.attackTarget.x]).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && mx < bc19.Util.myp.dist2(po) && po.dist2(bc19.Util.attackTarget) <= 64) {
            ...
            else if (!Pilgrim.miner) {
                {
                    ...
                    if (bc19.Util.dest === bc19.Util.myp) {
                        ...
                        if (Pilgrim.nearestDep != null && bc19.Util.myp.distxy(Pilgrim.nearestDep) <= 6) {
        ...
        /*private*/ Pilgrim.justRunAway = function () {
            ...
            if (bc19.Util.mr.getRobot(bc19.Util.dangerEnemyId).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                {
                    ...
                    for (var index156 = 0; index156 < array157.length; index156++) {
                        ...
                        {
                            var po = bc19.Util.myp.dir4To(dir);
                            if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2(bc19.Util.dangerEnemy) > 26) {
                                Pilgrim.runAway = po;
                                break;
                            }
                        }
            ...
            }
            {
                ...
                for (var index158 = 0; index158 < array159.length; index158++) {
                    ...
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2(bc19.Util.dangerEnemy) > bc19.Util.mr.SPECS.UNITS[bc19.Util.mr.getRobot(bc19.Util.dangerEnemyId).unit].VISION_RADIUS) {
                            Pilgrim.runAway = po;
                            break;
                        }
                    }
            ...
            }
            {
                ...
                for (var index160 = 0; index160 < array161.length; index160++) {
                    ...
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2(bc19.Util.dangerEnemy) > bc19.Util.mr.SPECS.UNITS[bc19.Util.mr.getRobot(bc19.Util.dangerEnemyId).unit].ATTACK_RADIUS[1]) {
                            Pilgrim.runAway = po;
                            break;
                        }
                    }
        ...
        /*private*/ Pilgrim.canReach = function (po) {
            if (bc19.Util.myp.dist2(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po) && Pilgrim.isItSafe(po))
                return true;
            return false;
        };
        /*private*/ Pilgrim.canHalfReach = function (po) {
            if (bc19.Util.myp.dist2(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po) && Pilgrim.isItHalfSafe(po))
                return true;
            return false;
        };
        /*private*/ Pilgrim.safeToGo = function (po) {
            if (bc19.Util.attackTarget == null || (po.dist2(bc19.Util.attackTarget) > bc19.Util.mr.SPECS.UNITS[bc19.Util.attackTargetR.unit].VISION_RADIUS && (bc19.Util.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number() || bc19.Util.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Crusader].number())) || (po.dist2(bc19.Util.attackTarget) > 26 && bc19.Util.attackTargetR.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()))
                return true;
            return false;
        };
        Pilgrim.isItSafe = function (po) {
            for (var index162 = 0; index162 < bc19.Util.seenO.length; index162++) {
                var ppo = bc19.Util.seenO[index162];
                {
                    ...
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && po.dist2(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                    if (po.dist2(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].VISION_RADIUS)
                        return false;
                }
            }
            return true;
        ...
        /*private*/ Pilgrim.isItHalfSafe = function (po) {
            for (var index163 = 0; index163 < bc19.Util.seenO.length; index163++) {
                var ppo = bc19.Util.seenO[index163];
                {
                    ...
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && po.dist2(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                    if (po.dist2(ppo) <= bc19.Util.mr.SPECS.UNITS[ppo.unit].ATTACK_RADIUS[1])
                        return false;
                }
            }
            return true;
            ...
            var pp;
            {
                ...
                for (var index164 = 0; index164 < array165.length; index164++) {
                    var r = array165[index164];
                    {
                        ...
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(pp) <= 100) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                value = 1;
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                                value = 2;
                        ...
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && ((bc19.Util.myp.dist2(pp) <= bc19.Util.mr.SPECS.UNITS[r.unit].VISION_RADIUS && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number() && r.unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) || (bc19.Util.myp.dist2(pp) <= 26 && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()))) {
                            if (mn > bc19.Util.myp.dist2(pp)) {
                                poo = pp;
                                bc19.Util.dangerEnemyId = r.id;
                                mn = bc19.Util.myp.dist2(pp);
                            }
                        }
                    }
                }
            ...
            for (var index166 = 0; index166 < bc19.Util.seenIR.length; index166++) {
                var r = bc19.Util.seenIR[index166];
                {
                    ...
                    if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() || r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()) {
                        if (mns > bc19.Util.myp.distxy(pp)) {
                            Pilgrim.nearestDep = pp;
                            mns = bc19.Util.myp.distxy(pp);
                        }
                    }
                }
            }
    ...
    var Castle = (function (_super) {
        ...
        Castle.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn % 200 === 0)
                Castle.rushSize = 4;
            if (bc19.Util.me.turn === 1) {
                Castle.estlen = bc19.Util.myp.distxy(bc19.Util.revPoint(bc19.Util.myp));
                ...
                for (var index173 = 0; index173 < bc19.Util.resP_$LI$().length; index173++) {
                    var po = bc19.Util.resP_$LI$()[index173];
                    {
                        if (bc19.Util.myp.distxy(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
            ...
            if (bc19.Util.attackTarget != null && (Castle.ut == null || Castle.ut !== bc19.UnitType.Preacher || Castle.cpu == null || bc19.Util.mr.karbonite < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Castle.ut].number()].CONSTRUCTION_KARBONITE || bc19.Util.mr.fuel < bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][Castle.ut].number()].CONSTRUCTION_FUEL)) {
        ...
        /*private*/ Castle.assign = function () {
            ...
            if (Castle.ut === bc19.UnitType.Pilgrim && bc19.Util.me.turn < 100) {
                ...
                bc19.Util.mainPath = bc19.Nav.nextAssignDefBackPro();
                if (bc19.Util.mainPath != null && bc19.Util.mainPath.length !== 0) {
                    Castle.assignNode = bc19.Util.mainPath.pop();
                }
            }
        ...
        /*private*/ Castle.readyForPush = function () {
            if (bc19.Util.me.turn >= 20) {
                if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_FUEL && (bc19.Util.pre % Castle.rushSize !== Castle.rushSize || (bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].FUEL_PER_MOVE * Castle.estlen * Math.max(Castle.estFighter, Castle.rushSize * Castle.appx)))) {
                    bc19.Util.mr.log("SWAT: " + Castle.estFighter + " - " + Castle.unitNum + " - " + Castle.rushSize + " - " + Castle.appx + " - " + Castle.estlen);
                    return bc19.UnitType.Preacher;
                }
                else {
                    if (bc19.Util.mr.karbonite >= 50 + 25 && bc19.Util.mr.fuel >= 200 + 50 && bc19.Util.seenIProNear < 3)
        ...
        /*private*/ Castle.goForHaras = function () {
            if (bc19.Util.me.turn === 1) {
                ...
                if (etx != null) {
                    bc19.Util.mr.log("etx: " + ((bc19.Util.myp.distxy(bc19.Util.revPoint(etx)) / 3 | 0)) + " - " + ((bc19.Util.myp.distxy(etx) / 2 | 0)));
                    if ((bc19.Util.myp.distxy(bc19.Util.revPoint(etx)) / 3 | 0) <= (bc19.Util.myp.distxy(etx) / 2 | 0))
        ...
        /*private*/ Castle.goodTimeForRush = function () {
            {
                if (bc19.Communication.smessage % 16 !== 10)
                    Castle.wave = 0;
                if (bc19.Util.pre !== 0 && bc19.Util.pre % Castle.rushSize === 0 && !Castle.vwave) {
        ...
        /*private*/ Castle.checkFight = function () {
            ...
            var po = null;
            var poo = null;
            for (var index174 = 0; index174 < bc19.Util.seenOR.length; index174++) {
                var r = bc19.Util.seenOR[index174];
                {
                    if (bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 64) {
                        if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                            value = 1;
                        if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())
                            value = 2;
                        ...
                        if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number())
                            value = 5;
                        value = 100 * value - bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]);
                        if (value > mx) {
                            po = bc19.Util.p[r.x][r.y];
                            mx = value;
                        }
                    }
                    if (bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 100) {
        ...
        /*private*/ Castle.produceNewUnit = function (unitType) {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array178 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index177 = 0; index177 < array178.length; index177++) {
                    var dir = array178[index177];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
...
(function (bc19) {
    var Communication = (function (_super) {
        ...
        /*private*/ Communication.handleCastleIn = function (r) {
            ...
            if (opcode === 1) {
                ...
                if (Communication.decode(r.castle_talk, 0, 4) === 4 * 1) {
                    ...
                    if (bc19.Util.mr.isVisible(r) && bc19.Util.p[r.x][r.y].dist2(bc19.Util.myp) <= 100 && bc19.Util.p[r.x][r.y].dist2(bc19.Util.myp) > Communication.maxSignalRangeExpand) {
                        Communication.maxSignalRangeExpand = bc19.Util.p[r.x][r.y].dist2(bc19.Util.myp);
                    }
                }
        ...
        Communication.signalInPreacher = function () {
            ...
            {
                var array182 = bc19.Util.mr.getVisibleRobots();
                for (var index181 = 0; index181 < array182.length; index181++) {
                    var r = array182[index181];
                    {
        ...
        Communication.signalOutCastle = function () {
            if (Communication.maxSignalRangeExpand !== 0) {
                ...
                if (Communication.maxSignalRangeM !== 0 && bc19.Castle.wave !== 0) {
                    ...
                    if (bc19.Util.me.turn >= 150) {
                        ...
                        if (Communication.maxSignalRange === 0) {
                            ...
                            if ((function (m) { if (m.entries == null)
                                ...
                                var t = bc19.Util.me.turn % 2;
                                {
                                    var array188 = (function (m) { var r = []; if (m.entries == null)
                                        m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                        r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                                    for (var index187 = 0; index187 < array188.length; index187++) {
                                        var id = array188[index187];
                                        {
                                            if (t === 0) {
                                                Communication.smessage = (function (m, k) { if (m.entries == null)
                                                    m.entries = []; for (var i = 0; i < m.entries.length; i++)
                    ...
                    bc19.Util.mr.log("HH5");
                    if (Communication.maxSignalRange === 0)
                        return;
                    if ((function (m) { if (m.entries == null)
                        m.entries = []; return m.entries.length; })(bc19.Util.xid_$LI$()) === 2) {
                        bc19.Util.mr.log("HH7");
                        var t = bc19.Util.me.turn % 2;
                        {
        ...
        Communication.signalOut = function () {
            if (Communication.maxSignalRangeExpand !== 0) {
                ...
                bc19.Util.mr.log("signal : " + Communication.smessage + " - " + Communication.maxSignalRangeExpand);
            }
            else {
                if (Communication.maxSignalRangeM !== 0 && bc19.Castle.wave !== 0) {
        ...
        Communication.signalInPilgrim = function () {
            ...
            bc19.Preacher.stopCommand = false;
            {
                var array196 = bc19.Util.mr.getVisibleRobots();
                for (var index195 = 0; index195 < array196.length; index195++) {
                    var r = array196[index195];
                    {
                        if (!bc19.Util.mr.isRadioing(r) || (bc19.Util.mr.isVisible(r) && bc19.Util.mr.getRobot(r.id).team !== bc19.Team["_$wrappers"][bc19.Util.teami].number()))
                            continue;
    ...
    var Nav = (function (_super) {
        ...
        Nav.destSetPilgrimToResource = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                ...
                {
                    var array198 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index197 = 0; index197 < array198.length; index197++) {
                        var dir = array198[index197];
                        {
                            pi = po.dir4To(dir);
                ...
                if (mxx != null && po.dist2(bc19.Util.myp) > 25) {
                    bc19.Util.dest = mxx;
        ...
        Nav.backResourceToCC = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array200 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index199 = 0; index199 < array200.length; index199++) {
                        var dir = array200[index199];
                        {
                            pi = po.dir4To(dir);
        ...
        /*private*/ Nav.calcEnemyCastle = function () {
            for (var index201 = 0; index201 < bc19.Util.castlei_$LI$().length; index201++) {
                var po = bc19.Util.castlei_$LI$()[index201];
                {
        ...
        /*private*/ Nav.sadbfs = function (goal) {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array203 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index202 = 0; index202 < array203.length; index202++) {
                        var dir = array203[index202];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
        ...
        Nav.AStarIsBack4 = function (goal) {
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array205 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index204 = 0; index204 < array205.length; index204++) {
                        var dir = array205[index204];
                        {
                            ++Nav.ins;
                            pi = po.dir4To(dir);
        ...
        Nav.AStarIsBack4p = function (goal) {
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array207 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index206 = 0; index206 < array207.length; index206++) {
                        var dir = array207[index206];
                        {
                            ++Nav.ins;
                            pi = po.dir4To(dir);
                            if (pi == null || closedSet[pi.x][pi.y] || !pi.passable || (bc19.Util.myp === po && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] !== 0))
        ...
        Nav.defCastleWithPreacher = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    ...
                    for (var index208 = 0; index208 < array209.length; index208++) {
                        var dir = array209[index208];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && pi.dist2(bc19.Util.myCastle) <= 36) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -pi.dist2(Nav.agoal);
                                if (value >= mx && pi.dist2(bc19.Util.myCastle) > 8 && !pi.karbonite && !pi.fuel && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] === 0) {
                                    mx = value;
                                    mxx = pi;
                                }
                            }
                ...
                if (po.dist2(bc19.Util.myCastle) > 36 && mxx != null) {
                    bc19.Util.dest = mxx;
                    ppo = parent[bc19.Util.dest.x][bc19.Util.dest.y];
                    /* push */ (path.push(bc19.Util.dest) > 0);
                    while ((parent[ppo.x][ppo.y] != null)) {
        ...
        Nav.goForExpand1 = function () {
            ...
            var mnn = 1000000;
            var gg = null;
            for (var index212 = 0; index212 < bc19.Util.karbonP_$LI$().length; index212++) {
                var kp = bc19.Util.karbonP_$LI$()[index212];
                {
                    mn = 1000000;
                    for (var index213 = 0; index213 < bc19.Util.castlei_$LI$().length; index213++) {
                        var po = bc19.Util.castlei_$LI$()[index213];
                        {
                            if (kp.distxy(po) < mn)
                                mn = kp.distxy(po);
                        }
                    }
                    for (var index214 = 0; index214 < bc19.Util.castleo_$LI$().length; index214++) {
                        var po = bc19.Util.castleo_$LI$()[index214];
                        {
                            if (kp.distxy(po) < mn)
                                mn = kp.distxy(po);
                        }
                    }
                    if (kp.distxy(bc19.Util.myCastle) <= mn) {
                        /* add */ (myexp.push(kp) > 0);
                        if (bc19.Util.mr.getVisibleRobotMap()[kp.y][kp.x] <= 0) {
                            if (kp.distxy(bc19.Util.myp) < mnn) {
                                mnn = kp.distxy(bc19.Util.myp);
                                gg = kp;
                            }
                        }
                    }
        ...
        Nav.expandTargeti = function () {
            ...
            var value;
            var gg = null;
            for (var index215 = 0; index215 < bc19.Util.resToDep_$LI$().length; index215++) {
                var po = bc19.Util.resToDep_$LI$()[index215];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index216 = 0; index216 < bc19.Util.castlei_$LI$().length; index216++) {
                        var poo = bc19.Util.castlei_$LI$()[index216];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    }
                    for (var index217 = 0; index217 < bc19.Util.castleo_$LI$().length; index217++) {
                        var poo = bc19.Util.castleo_$LI$()[index217];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    }
                    if (po.distxy(bc19.Util.myp) <= mn) {
                        var valid = true;
                        for (var index218 = 0; index218 < bc19.Castle.doneDep_$LI$().length; index218++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index218];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index219 = 0; index219 < bc19.Castle.lookInProg_$LI$().length; index219++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index219];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index220 = 0; index220 < bc19.Util.castlei_$LI$().length; index220++) {
                            var pp = bc19.Util.castlei_$LI$()[index220];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.nextAssignDefPre = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array228 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index227 = 0; index227 < array228.length; index227++) {
                        var dir = array228[index227];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && pi.dist2(bc19.Util.myp) <= 36 && (bc19.Util.myp !== po || bc19.Direction4["_$wrappers"][dir].number() < 8)) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -pi.dist2(Nav.agoal);
                                if (value >= mx && pi.dist2(bc19.Util.myp) > 8 && !pi.karbonite && !pi.fuel) {
                                    mx = value;
                                    mxx = pi;
                                }
                            }
                ...
                if (po.dist2(bc19.Util.myp) > 36 && mxx != null) {
                    bc19.Util.dest = mxx;
                    ppo = parent[bc19.Util.dest.x][bc19.Util.dest.y];
                    /* push */ (path.push(bc19.Util.dest) > 0);
                    while ((parent[ppo.x][ppo.y] != null)) {
        ...
        Nav.defWithProphet = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array230 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index229 = 0; index229 < array230.length; index229++) {
                        var dir = array230[index229];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0)) {
                                ...
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                if ((pi.x + pi.y) % 2 === 0 && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && !pi.karbonite && !pi.fuel && pi.dist2(bc19.Util.myp) > 2) {
                                    bc19.Util.dest = pi;
                                    ppo = bc19.Util.dest;
                                    while ((parent[ppo.x][ppo.y] != null)) {
                                        /* push */ (path.push(ppo) > 0);
        ...
        Nav.defWithProphet2 = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array232 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index231 = 0; index231 < array232.length; index231++) {
                        var dir = array232[index231];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && (bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 || (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() && bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x]).unit !== bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) && pi.dist2(bc19.Util.myCC) <= 36) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -bc19.Util.myCC.dist2(pi) * 100;
                                if (bc19.Util.top)
                                    value += pi.y;
                                if (bc19.Util.down)
                                    value += -pi.y;
                                ...
                                if (bc19.Util.right)
                                    value += -pi.x;
                                if (value >= mx)
                                    if ((pi.x + pi.y) % 2 === (bc19.Util.myCC.x + bc19.Util.myCC.y) % 2 && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0 && !pi.karbonite && !pi.fuel && pi.dist2(bc19.Util.myCC) > 2 && ((bc19.Util.top && pi.y >= bc19.Util.myCC.y) || (bc19.Util.down && pi.y <= bc19.Util.myCC.y) || (bc19.Util.left && pi.x >= bc19.Util.myCC.x) || (bc19.Util.right && pi.x <= bc19.Util.myCC.x))) {
                                        mx = value;
                                        mxx = pi;
                                    }
                            }
        ...
        /*private*/ Nav.AStarIsBack9h = function (goal) {
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array240 = function () { var result = []; for (var val in bc19.Direction9) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
        ...
        Nav.expandTargetCCC = function () {
            ...
            var value;
            var gg = null;
            for (var index241 = 0; index241 < bc19.Util.resToDep_$LI$().length; index241++) {
                var po = bc19.Util.resToDep_$LI$()[index241];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index242 = 0; index242 < bc19.Util.castlei_$LI$().length; index242++) {
                        var poo = bc19.Util.castlei_$LI$()[index242];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    }
                    for (var index243 = 0; index243 < bc19.Util.castleo_$LI$().length; index243++) {
                        var poo = bc19.Util.castleo_$LI$()[index243];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    }
                    if (po.distxy(bc19.Util.myCC) <= mn) {
                        var valid = true;
                        for (var index244 = 0; index244 < bc19.Castle.doneDep_$LI$().length; index244++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index244];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index245 = 0; index245 < bc19.Castle.lookInProg_$LI$().length; index245++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index245];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index246 = 0; index246 < bc19.Util.castlei_$LI$().length; index246++) {
                            var pp = bc19.Util.castlei_$LI$()[index246];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
...
(function (bc19) {
    var Preacher = (function (_super) {
        ...
        Preacher.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array248 = bc19.Util.mr.getVisibleRobots();
                    for (var index247 = 0; index247 < array248.length; index247++) {
                        var r = array248[index247];
                        {
                            if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                                /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                                    s.push(e);
            ...
            if (Preacher.attackTarget != null) {
                ...
                bc19.Util.mr.log("KK3");
                if (bc19.Util.dest != null && bc19.Util.dest !== bc19.Util.myp) {
                    var po = (function (s) { return s[s.length - 1]; })(bc19.Util.mainPath);
                    bc19.Util.mr.log("ss1 " + Preacher.slowRush + " - " + po);
                    if (Preacher.slowRush && bc19.Util.myp.dist2(po) === 4) {
        ...
        /*private*/ Preacher.canReach = function (po) {
            if (bc19.Util.myp.dist2(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && Preacher.checkPreNear(po) && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po))
                return true;
            return false;
        };
        ...
        /*private*/ Preacher.setAttackLand = function () {
            ...
            var poo = null;
            {
                var array250 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index249 = 0; index249 < array250.length; index249++) {
                    var dir = array250[index249];
                    {
                        ...
                        e = 0;
                        {
                            var array252 = function () { var result = []; for (var val in bc19.Direction) {
                                if (!isNaN(val)) {
                                    result.push(parseInt(val, 10));
                                }
                            } return result; }();
                            for (var index251 = 0; index251 < array252.length; index251++) {
                                var dir2 = array252[index251];
                                {
                                    poo = po.dirTo(dir2);
                                    if (poo == null)
                                        continue;
        ...
        /*private*/ Preacher.checkFight = function () {
            ...
            var poo = null;
            {
                var array254 = bc19.Util.mr.getVisibleRobots();
                for (var index253 = 0; index253 < array254.length; index253++) {
                    var r = array254[index253];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 16) {
...
(function (bc19) {
    var Church = (function (_super) {
        ...
        Church.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                bc19.Util.myCC = bc19.Util.myp;
                for (var index257 = 0; index257 < bc19.Util.resP_$LI$().length; index257++) {
                    var po = bc19.Util.resP_$LI$()[index257];
                    {
                        if (bc19.Util.myp.distxy(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
        ...
        /*private*/ Church.checkFight = function () {
            ...
            var poo = null;
            {
                var array259 = bc19.Util.mr.getVisibleRobots();
                for (var index258 = 0; index258 < array259.length; index258++) {
                    var r = array259[index258];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
        ...
        /*private*/ Church.canProduceUnit = function () {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array261 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index260 = 0; index260 < array261.length; index260++) {
                    var dir = array261[index260];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                            return dir;
        ...
        /*private*/ Church.produceNewUnit = function (unitType) {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array263 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index262 = 0; index262 < array263.length; index262++) {
                    var dir = array263[index262];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                            bc19.Util.mr.log("Building a pilgrim. x : " + p2.x + " y : " + p2.y);
...
(function (bc19) {
    var Prophet = (function (_super) {
        ...
        Prophet.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array265 = bc19.Util.mr.getVisibleRobots();
                    for (var index264 = 0; index264 < array265.length; index264++) {
                        var r = array265[index264];
                        if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number() || r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number())) {
                            if (bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 2) {
                                bc19.Util.myCC = bc19.Util.p[r.x][r.y];
                                if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
        ...
        /*private*/ Prophet.tryToGoToSafe = function () {
            ...
            {
                var array267 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index266 = 0; index266 < array267.length; index266++) {
                    var dir = array267[index266];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
            ...
            if (Prophet.runAway == null) {
                var array269 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
        ...
        /*private*/ Prophet.canReachN = function (po) {
            if (bc19.Util.myp.dist2(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po))
                return true;
            return false;
        };
        /*private*/ Prophet.canReach = function (po) {
            if (bc19.Util.myp.dist2(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po) && Prophet.isItSafe(po))
                return true;
            return false;
        };
        /*private*/ Prophet.canHalfReach = function (po) {
            if (bc19.Util.myp.dist2(po) <= 4 && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.passable && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Prophet].number()].FUEL_PER_MOVE * bc19.Util.myp.dist2(po) && Prophet.isItHalfSafe(po))
                return true;
            return false;
        };
        Prophet.isItSafe = function (po) {
            for (var index270 = 0; index270 < bc19.Util.seenO.length; index270++) {
                var ppo = bc19.Util.seenO[index270];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2(ppo) <= 26)
        ...
        /*private*/ Prophet.isItHalfSafe = function (po) {
            for (var index271 = 0; index271 < bc19.Util.seenO.length; index271++) {
                var ppo = bc19.Util.seenO[index271];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2(ppo) <= 16)
        ...
        /*private*/ Prophet.justRunAway = function () {
            Prophet.runAway = null;
            {
                var array273 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index272 = 0; index272 < array273.length; index272++) {
                    ...
                    {
                        var po = bc19.Util.myp.dir4To(dir);
                        if (po != null && po.passable && bc19.Util.mr.getVisibleRobotMap()[po.y][po.x] === 0 && po.dist2(bc19.Util.dangerEnemy) > 16) {
                            Prophet.runAway = po;
                            break;
                        }
                    }
