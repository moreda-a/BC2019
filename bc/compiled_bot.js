    ...
    var Pilgrim = (function (_super) {
        ...
        Pilgrim.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                ...
                bc19.Util.resGoalP = ([]);
                for (var index135 = 0; index135 < bc19.Util.resP_$LI$().length; index135++) {
                    var po = bc19.Util.resP_$LI$()[index135];
                    {
            ...
            if (Pilgrim.ret) {
                bc19.Util.resGoalP = ([]);
                for (var index136 = 0; index136 < bc19.Util.resP_$LI$().length; index136++) {
                    var po = bc19.Util.resP_$LI$()[index136];
                    {
                        if (bc19.Util.myp.distxy(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
            ...
            if (Pilgrim.scouting) {
                if (bc19.Util.dangerEnemy == null && bc19.Util.attackTarget != null) {
                    if (bc19.Util.mr.getRobot(bc19.Util.mr.getVisibleRobotMap()[bc19.Util.attackTarget.y][bc19.Util.attackTarget.x]).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                        var value = void 0;
                        var mx = 0;
                        for (var index137 = 0; index137 < bc19.Util.seenI.length; index137++) {
                            var po = bc19.Util.seenI[index137];
                            {
            ...
            else if (!Pilgrim.miner) {
                {
                    ...
                    if (bc19.Util.dest != null && bc19.Util.dest !== bc19.Util.myp) {
                        ...
                        if (po == null) {
                            var px = null;
                            {
                                var array139 = function () { var result = []; for (var val in bc19.Direction4) {
                                    if (!isNaN(val)) {
                                        result.push(parseInt(val, 10));
                                    }
                                } return result; }();
        ...
        /*private*/ Pilgrim.tryToGoToSafe = function () {
            ...
            {
                var array141 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
            ...
            if (Pilgrim.runAway == null) {
                var array143 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index142 = 0; index142 < array143.length; index142++) {
                    var dir = array143[index142];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
        ...
        /*private*/ Pilgrim.rBuildChurch = function () {
            ...
            bc19.Util.mr.log("build attempt");
            if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number()].CONSTRUCTION_FUEL) {
                var array145 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index144 = 0; index144 < array145.length; index144++) {
                    var dir = array145[index144];
                    {
        ...
        /*private*/ Pilgrim.justRunAway = function () {
            ...
            if (bc19.Util.mr.getRobot(bc19.Util.dangerEnemyId).unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()) {
                {
                    var array147 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index146 = 0; index146 < array147.length; index146++) {
                        var dir = array147[index146];
                        {
                            var po = bc19.Util.myp.dir4To(dir);
        ...
        Pilgrim.isItSafe = function (po) {
            for (var index152 = 0; index152 < bc19.Util.seenO.length; index152++) {
                var ppo = bc19.Util.seenO[index152];
                {
        ...
        /*private*/ Pilgrim.isItHalfSafe = function (po) {
            for (var index153 = 0; index153 < bc19.Util.seenO.length; index153++) {
                var ppo = bc19.Util.seenO[index153];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
        ...
        /*private*/ Pilgrim.checkFight = function () {
            ...
            for (var index156 = 0; index156 < bc19.Util.seenIR.length; index156++) {
                var r = bc19.Util.seenIR[index156];
                {
                    pp = bc19.Util.p[r.x][r.y];
        ...
        /*private*/ Pilgrim.canGive = function () {
            {
                var array158 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index157 = 0; index157 < array158.length; index157++) {
                    var dir = array158[index157];
                    {
        ...
        /*private*/ Pilgrim.canMove = function () {
            ...
            var ddir = null;
            {
                var array160 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index159 = 0; index159 < array160.length; index159++) {
                    var dir = array160[index159];
                    {
                        var p2 = bc19.Util.myp.dirTo(dir);
    ...
    var Castle = (function (_super) {
        ...
        Castle.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                ...
                for (var index163 = 0; index163 < bc19.Util.resP_$LI$().length; index163++) {
                    var po = bc19.Util.resP_$LI$()[index163];
                    {
                        if (bc19.Util.myp.distxy(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
            ...
            else if (bc19.Util.pre % Castle.rushSize !== 0) {
                Castle.vwave = false;
            }
            bc19.Communication.turn();
        ...
        /*private*/ Castle.nextUnit = function () {
            if (Castle.appx === 1) {
                ...
                if (bc19.Util.seenO.length !== 0 && bc19.Util.seenIPre + bc19.Util.seenIPro < bc19.Util.seenO.length) {
                ...
                if (Castle.stopUsingRes)
                    return null;
                if (bc19.Util.seenIPilNear < bc19.Util.resGoalP_$LI$().length && (bc19.Util.pil < 2 || bc19.Util.mr.karbonite >= 10 && bc19.Util.mr.fuel >= 50) && bc19.Util.seenO.length === 0)
                    return bc19.UnitType.Pilgrim;
                if (bc19.Util.me.turn >= 20) {
                    if (bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].CONSTRUCTION_FUEL && (bc19.Util.pre % Castle.rushSize !== Castle.rushSize - 1 || bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number()].FUEL_PER_MOVE * Castle.estlen * Math.max(Castle.estFighter, Castle.rushSize * Castle.appx))) {
                ...
                }
                {
                    if (bc19.Util.seenIPilNear >= bc19.Util.resGoalP_$LI$().length && Castle.pili < 8 && bc19.Util.mr.karbonite >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].CONSTRUCTION_KARBONITE && bc19.Util.mr.fuel >= bc19.Util.mr.SPECS.UNITS[bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number()].CONSTRUCTION_FUEL && (Castle.lastPili === -1 || bc19.Util.me.turn > Castle.lastPili + 10)) {
                        if (bc19.Nav.expandTargetXXX() != null && (bc19.Util.pre >= 1 || bc19.Util.mr.karbonite >= 10 && bc19.Util.mr.fuel >= 50) && bc19.Util.seenO.length === 0) {
        ...
        /*private*/ Castle.checkFight = function () {
            ...
            var po = null;
            var poo = null;
            for (var index164 = 0; index164 < bc19.Util.seenOR.length; index164++) {
                var r = bc19.Util.seenOR[index164];
                {
        ...
        /*private*/ Castle.canProduceUnit = function () {
            ...
            {
                var array166 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
...
(function (bc19) {
    var Communication = (function (_super) {
        ...
        Communication.castleInCastle = function () {
            ...
            {
                var array170 = bc19.Util.mr.getVisibleRobots();
                for (var index169 = 0; index169 < array170.length; index169++) {
                    var r = array170[index169];
                    {
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number()) {
                            if (!bc19.Util.mr.isVisible(r) || r.x !== bc19.Util.myp.x || r.y !== bc19.Util.myp.y) {
                                bc19.Castle.unitNum++;
            ...
            if (Communication.maxSignalRangeExpand !== 0) {
                ...
                if (Communication.maxSignalRangeM !== 0 && bc19.Castle.wave !== 0) {
                    ...
                    if (bc19.Util.me.turn >= 150) {
                        if (Communication.maxSignalRange === 0) {
                            ...
                            if ((function (m) { if (m.entries == null)
                                ...
                                {
                                    var array176 = (function (m) { var r = []; if (m.entries == null)
                                        m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                        r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                                    for (var index175 = 0; index175 < array176.length; index175++) {
                                        var id = array176[index175];
                                        {
                                            Communication.smessage = (function (m, k) { if (m.entries == null)
                                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                                if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                        ...
                        if (Communication.maxSignalRange === 0) {
                            ...
                            if ((function (m) { if (m.entries == null)
                                ...
                                bc19.Util.mr.log("HH4");
                                {
                                    var array180 = (function (m) { var r = []; if (m.entries == null)
                                        m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                        r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                                    for (var index179 = 0; index179 < array180.length; index179++) {
                                        var id = array180[index179];
                                        {
                                            Communication.smessage = (function (m, k) { if (m.entries == null)
                                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                                if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                    ...
                    if ((function (m) { if (m.entries == null)
                        ...
                        var t = bc19.Util.me.turn % 2;
                        {
                            var array182 = (function (m) { var r = []; if (m.entries == null)
                                m.entries = []; for (var i = 0; i < m.entries.length; i++)
                                r.push(m.entries[i].key); return r; })(bc19.Util.xid_$LI$());
                            for (var index181 = 0; index181 < array182.length; index181++) {
                                var id = array182[index181];
                                {
                                    if (t === 0) {
                                        Communication.smessage = (function (m, k) { if (m.entries == null)
                                            m.entries = []; for (var i = 0; i < m.entries.length; i++)
    ...
    var Nav = (function (_super) {
        ...
        Nav.destSetPilgrimToResource = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                ...
                {
                    var array188 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index187 = 0; index187 < array188.length; index187++) {
                        var dir = array188[index187];
                        {
                            pi = po.dir4To(dir);
        ...
        Nav.backResourceToCC = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array190 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index189 = 0; index189 < array190.length; index189++) {
                        var dir = array190[index189];
                        {
                            pi = po.dir4To(dir);
        ...
        /*private*/ Nav.calcEnemyCastle = function () {
            for (var index191 = 0; index191 < bc19.Util.castlei_$LI$().length; index191++) {
                var po = bc19.Util.castlei_$LI$()[index191];
                {
        ...
        /*private*/ Nav.sadbfs = function (goal) {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array193 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index192 = 0; index192 < array193.length; index192++) {
                        var dir = array193[index192];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
        ...
        Nav.AStarIsBack4 = function (goal) {
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array195 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index194 = 0; index194 < array195.length; index194++) {
                        var dir = array195[index194];
                        {
                            ++Nav.ins;
                            pi = po.dir4To(dir);
        ...
        Nav.AStarIsBack4p = function (goal) {
            ...
            while ((fq.size() !== 0)) {
                ...
                Nav.flag = 5;
                {
                    var array197 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index196 = 0; index196 < array197.length; index196++) {
                        var dir = array197[index196];
                        {
                            ++Nav.ins;
                            pi = po.dir4To(dir);
                            if (pi == null || closedSet[pi.x][pi.y] || !pi.passable || (bc19.Util.myp === po && bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] !== 0))
        ...
        Nav.defCastleWithPreacher = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array199 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index198 = 0; index198 < array199.length; index198++) {
                        var dir = array199[index198];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && pi.dist2(bc19.Util.myCastle) <= 16) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                ...
                if (po.dist2(bc19.Util.myCastle) > 16 && mxx != null) {
                    bc19.Util.dest = mxx;
                    ppo = parent[bc19.Util.dest.x][bc19.Util.dest.y];
                    /* push */ (path.push(bc19.Util.dest) > 0);
                    while ((parent[ppo.x][ppo.y] != null)) {
        ...
        Nav.nextAssignRes = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array201 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index200 = 0; index200 < array201.length; index200++) {
                        var dir = array201[index200];
                        {
                            pi = po.dir4To(dir);
        ...
        Nav.goForExpand1 = function () {
            ...
            var mnn = 1000000;
            var gg = null;
            for (var index202 = 0; index202 < bc19.Util.karbonP_$LI$().length; index202++) {
                var kp = bc19.Util.karbonP_$LI$()[index202];
                {
                    mn = 1000000;
                    for (var index203 = 0; index203 < bc19.Util.castlei_$LI$().length; index203++) {
                        var po = bc19.Util.castlei_$LI$()[index203];
                        {
                            if (kp.distxy(po) < mn)
                                mn = kp.distxy(po);
                        }
                    }
                    for (var index204 = 0; index204 < bc19.Util.castleo_$LI$().length; index204++) {
                        var po = bc19.Util.castleo_$LI$()[index204];
                        {
                            if (kp.distxy(po) < mn)
                                mn = kp.distxy(po);
                        }
        ...
        Nav.expandTargeti = function () {
            ...
            var value;
            var gg = null;
            for (var index205 = 0; index205 < bc19.Util.resToDep_$LI$().length; index205++) {
                var po = bc19.Util.resToDep_$LI$()[index205];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index206 = 0; index206 < bc19.Util.castlei_$LI$().length; index206++) {
                        var poo = bc19.Util.castlei_$LI$()[index206];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    }
                    for (var index207 = 0; index207 < bc19.Util.castleo_$LI$().length; index207++) {
                        var poo = bc19.Util.castleo_$LI$()[index207];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    ...
                    if (po.distxy(bc19.Util.myp) <= mn) {
                        var valid = true;
                        for (var index208 = 0; index208 < bc19.Castle.doneDep_$LI$().length; index208++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index208];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index209 = 0; index209 < bc19.Castle.lookInProg_$LI$().length; index209++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index209];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index210 = 0; index210 < bc19.Util.castlei_$LI$().length; index210++) {
                            var pp = bc19.Util.castlei_$LI$()[index210];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.expandTargetXXX = function () {
            ...
            var value;
            var gg = null;
            for (var index211 = 0; index211 < bc19.Util.resToDep_$LI$().length; index211++) {
                var po = bc19.Util.resToDep_$LI$()[index211];
                {
                    if (po == null)
                        continue;
                    mn = 1000000;
                    for (var index212 = 0; index212 < bc19.Util.castlei_$LI$().length; index212++) {
                        var poo = bc19.Util.castlei_$LI$()[index212];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    }
                    for (var index213 = 0; index213 < bc19.Util.castleo_$LI$().length; index213++) {
                        var poo = bc19.Util.castleo_$LI$()[index213];
                        {
                            if (po.distxy(poo) < mn)
                                mn = po.distxy(poo);
                        }
                    ...
                    if (po.distxy(bc19.Util.myp) <= mn) {
                        var valid = true;
                        for (var index214 = 0; index214 < bc19.Castle.doneDep_$LI$().length; index214++) {
                            var pp = bc19.Castle.doneDep_$LI$()[index214];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index215 = 0; index215 < bc19.Castle.lookInProg_$LI$().length; index215++) {
                            var pp = bc19.Castle.lookInProg_$LI$()[index215];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
                        ...
                        for (var index216 = 0; index216 < bc19.Util.castlei_$LI$().length; index216++) {
                            var pp = bc19.Util.castlei_$LI$()[index216];
                            {
                                if (pp.distxy(po) <= 5) {
                                    valid = false;
                                    break;
        ...
        Nav.nextAssignDefPre = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array218 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index217 = 0; index217 < array218.length; index217++) {
                        var dir = array218[index217];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0) && pi.dist2(bc19.Util.myp) <= 16 && (bc19.Util.myp !== po || bc19.Direction4["_$wrappers"][dir].number() < 8)) {
                                /* add */ (que.push(pi) > 0);
                                marked[pi.x][pi.y] = true;
                                parent[pi.x][pi.y] = po;
                                value = -pi.dist2(Nav.agoal);
                ...
                if (po.dist2(bc19.Util.myp) > 16 && mxx != null) {
                    bc19.Util.dest = mxx;
                    ppo = parent[bc19.Util.dest.x][bc19.Util.dest.y];
                    /* push */ (path.push(bc19.Util.dest) > 0);
                    while ((parent[ppo.x][ppo.y] != null)) {
        ...
        Nav.defWithProphet = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array220 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index219 = 0; index219 < array220.length; index219++) {
                        var dir = array220[index219];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
                            if (pi != null && !marked[pi.x][pi.y] && bc19.Util.p[pi.x][pi.y].passable && (bc19.Util.myp !== po || bc19.Util.mr.getVisibleRobotMap()[pi.y][pi.x] <= 0)) {
        ...
        Nav.defWithProphet2 = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array222 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index221 = 0; index221 < array222.length; index221++) {
                        var dir = array222[index221];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
        ...
        Nav.nextAssignDefPro = function () {
            ...
            /*outerloop:*/ while ((!(que.length == 0))) {
                po = (function (a) { return a.length == 0 ? null : a.shift(); })(que);
                {
                    var array224 = function () { var result = []; for (var val in bc19.Direction4) {
                        if (!isNaN(val)) {
                            result.push(parseInt(val, 10));
                        }
                    } return result; }();
                    for (var index223 = 0; index223 < array224.length; index223++) {
                        var dir = array224[index223];
                        {
                            Nav.ins++;
                            pi = po.dir4To(dir);
...
(function (bc19) {
    var Preacher = (function (_super) {
        ...
        Preacher.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array226 = bc19.Util.mr.getVisibleRobots();
                    for (var index225 = 0; index225 < array226.length; index225++) {
                        var r = array226[index225];
                        if (bc19.Util.mr.isVisible(r) && r.team === bc19.Team["_$wrappers"][bc19.Util.teami].number() && r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number()) {
                            /* add */ (function (s, e) { if (s.indexOf(e) == -1) {
                                s.push(e);
                                return true;
        ...
        /*private*/ Preacher.setAttackLand = function () {
            ...
            var poo = null;
            {
                var array228 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index227 = 0; index227 < array228.length; index227++) {
                    var dir = array228[index227];
                    {
                        ...
                        e = 0;
                        {
                            var array230 = function () { var result = []; for (var val in bc19.Direction) {
                                if (!isNaN(val)) {
                                    result.push(parseInt(val, 10));
                                }
                            } return result; }();
                            for (var index229 = 0; index229 < array230.length; index229++) {
                                var dir2 = array230[index229];
                                {
                                    poo = po.dirTo(dir2);
                                    if (poo == null)
                                        continue;
        ...
        /*private*/ Preacher.checkFight = function () {
            ...
            var poo = null;
            {
                var array232 = bc19.Util.mr.getVisibleRobots();
                for (var index231 = 0; index231 < array232.length; index231++) {
                    var r = array232[index231];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 16) {
        ...
        /*private*/ Preacher.canAttack = function () {
            ...
            var po = null;
            {
                var array234 = bc19.Util.mr.getVisibleRobots();
                for (var index233 = 0; index233 < array234.length; index233++) {
                    var r = array234[index233];
                    {
                        if (r.team === bc19.Team["_$wrappers"][bc19.Util.teamo].number() && bc19.Util.myp.dist2(bc19.Util.p[r.x][r.y]) <= 16) {
                            if (r.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Castle].number())
                                value = 1;
...
(function (bc19) {
    var Church = (function (_super) {
        ...
        Church.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                bc19.Util.myCC = bc19.Util.myp;
                for (var index235 = 0; index235 < bc19.Util.resP_$LI$().length; index235++) {
                    var po = bc19.Util.resP_$LI$()[index235];
                    {
                        if (bc19.Util.myp.distxy(po) <= 6)
                            (bc19.Util.resGoalP_$LI$().push(po) > 0);
                    }
        ...
        /*private*/ Church.nextUnit = function () {
            if (bc19.Util.seenIPilNear < bc19.Util.resGoalP_$LI$().length && (bc19.Util.pil < 2 || bc19.Util.mr.karbonite >= 40 && bc19.Util.mr.fuel >= 100) && bc19.Util.pil < 10 && bc19.Util.seenO.length === 0)
                return bc19.UnitType.Pilgrim;
            if (bc19.Util.seenO.length !== 0 && bc19.Util.seenIPre + bc19.Util.seenIPro < bc19.Util.seenO.length) {
                if (bc19.Util.seenIPre <= 2 * bc19.Util.seenIPro && (bc19.Util.me.health === 100 || bc19.Util.pro !== 0))
                    return bc19.UnitType.Preacher;
                else
                    return bc19.UnitType.Prophet;
            }
        ...
        /*private*/ Church.checkFight = function () {
            ...
            var poo = null;
            {
                var array237 = bc19.Util.mr.getVisibleRobots();
                for (var index236 = 0; index236 < array237.length; index236++) {
                    var r = array237[index236];
                    {
                        if (!bc19.Util.mr.isVisible(r))
                            continue;
        ...
        /*private*/ Church.canProduceUnit = function () {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array239 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index238 = 0; index238 < array239.length; index238++) {
                    var dir = array239[index238];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                            return dir;
        ...
        /*private*/ Church.produceNewUnit = function (unitType) {
            var p1 = bc19.Util.p[bc19.Util.me.x][bc19.Util.me.y];
            {
                var array241 = function () { var result = []; for (var val in bc19.Direction) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index240 = 0; index240 < array241.length; index240++) {
                    var dir = array241[index240];
                    {
                        var p2 = p1.dirTo(dir);
                        if (p2 != null && bc19.Util.p[p2.x][p2.y].passable && bc19.Util.mr.getVisibleRobotMap()[p2.y][p2.x] === 0) {
                            bc19.Util.mr.log("Building a pilgrim. x : " + p2.x + " y : " + p2.y);
...
(function (bc19) {
    var Prophet = (function (_super) {
        ...
        Prophet.turn = function (myRobot) {
            ...
            if (bc19.Util.me.turn === 1) {
                {
                    var array243 = bc19.Util.mr.getVisibleRobots();
                    for (var index242 = 0; index242 < array243.length; index242++) {
                        var r = array243[index242];
        ...
        /*private*/ Prophet.tryToGoToSafe = function () {
            ...
            {
                var array245 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index244 = 0; index244 < array245.length; index244++) {
                    var dir = array245[index244];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
            ...
            if (Prophet.runAway == null) {
                var array247 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index246 = 0; index246 < array247.length; index246++) {
                    var dir = array247[index246];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
        ...
        Prophet.isItSafe = function (po) {
            for (var index248 = 0; index248 < bc19.Util.seenO.length; index248++) {
                var ppo = bc19.Util.seenO[index248];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2(ppo) <= 26)
        ...
        /*private*/ Prophet.isItHalfSafe = function (po) {
            for (var index249 = 0; index249 < bc19.Util.seenO.length; index249++) {
                var ppo = bc19.Util.seenO[index249];
                {
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Church].number() || ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Pilgrim].number())
                        continue;
                    if (ppo.unit === bc19.UnitType["_$wrappers"][bc19.UnitType.Preacher].number() && po.dist2(ppo) <= 16)
        ...
        /*private*/ Prophet.justRunAway = function () {
            Prophet.runAway = null;
            {
                var array251 = function () { var result = []; for (var val in bc19.Direction4) {
                    if (!isNaN(val)) {
                        result.push(parseInt(val, 10));
                    }
                } return result; }();
                for (var index250 = 0; index250 < array251.length; index250++) {
                    var dir = array251[index250];
                    {
                        var po = bc19.Util.myp.dir4To(dir);
        ...
        /*private*/ Prophet.checkFight = function () {
            ...
            var poo = null;
            {
                var array253 = bc19.Util.mr.getVisibleRobots();
                for (var index252 = 0; index252 < array253.length; index252++) {
                    var r = array253[index252];
                    {
